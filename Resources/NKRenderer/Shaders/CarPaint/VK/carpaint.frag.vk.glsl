...
layout(set=2,binding=8,std140) uniform CarPaintUBO{float flakeScale,flakeIntensity,specF0,_pad;}uCar;
...
layout(set=2,binding=6) uniform sampler2D tFlake;          // sparkle normal map (slot emissive reused)
