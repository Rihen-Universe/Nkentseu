...
namespace nkentseu {
	namespace pong {
		...
		// layout responsive.
		// ─────────────────────────────────────────────────────────────────────
		static void DrawMiniField(renderer::NkRenderer2D &r, FontAtlas &f, float x, float y, float w, float h,
		...
		// ─────────────────────────────────────────────────────────────────────
		static void DrawIcon(renderer::NkRenderer2D &r, int iconId, float boxX, float boxY, float boxSize,
							 math::NkColor c) {
		...
		static void DrawBadge(renderer::NkRenderer2D &r, FontAtlas &f, FontAtlas::SizeSlot slot, float scale, float x,
							  float y, const char *text, math::NkColor accent) {
		...
		// ─────────────────────────────────────────────────────────────────────
		static float DrawItemCard(renderer::NkRenderer2D &r, FontAtlas &f, const MenuLayout &L, int itemIndex,
								  float baseY, bool focused, float globalTime, float alphaItem) {
