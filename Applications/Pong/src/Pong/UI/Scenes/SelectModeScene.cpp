...
namespace nkentseu {
	namespace pong {
		...
		static void DrawModeIcon(renderer::NkRenderer2D &r, int iconId, float boxX, float boxY, float boxSize,
								 math::NkColor c) {
		...
		void SelectModeScene::OnRender(AppContext &ctx) {
			...
			for (int i = 0; i < kModeCount; ++i) {
				...
				r.DrawRectOutline({bx, by + slideY, cardW, cardH}, bord, focused ? strokeFocused : 1.0f);
