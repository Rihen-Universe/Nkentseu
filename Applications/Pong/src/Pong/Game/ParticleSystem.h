	...
	namespace pong {
		...
		class ParticleSystem {
			public:
				...
				void EmitBurst(float x, float y, int count, math::NkColor color, float speedMin, float speedMax,
				...
				void EmitDirectional(float x, float y, int count, math::NkColor color, float dirAngle, float spread,
