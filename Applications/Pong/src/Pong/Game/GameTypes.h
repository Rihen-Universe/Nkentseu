...
namespace nkentseu {
	namespace pong {
		...
		// ─────────────────────────────────────────────────────────────────────
		enum class BallSpeedPreset { Slow, Normal, Fast };

		// ─────────────────────────────────────────────────────────────────────
		// VisualQuality — preset graphique (GDD §6).
		// Influe sur particules, glow GPU, scanlines.
		// ─────────────────────────────────────────────────────────────────────
		enum class VisualQuality { Low, Medium, High, Ultra };

		// ─────────────────────────────────────────────────────────────────────
		// DaltonianMode — mode daltonien optionnel (GDD §6).
		// ─────────────────────────────────────────────────────────────────────
		enum class DaltonianMode { Normal, Deuteranopia, Protanopia };

		// ─────────────────────────────────────────────────────────────────────
		// NetworkRegion — choix region serveur (GDD §6).
		// ─────────────────────────────────────────────────────────────────────
		enum class NetworkRegion { Auto, EU, US, AF };
		...
		struct GameSettings {
				...
				bool obsChaotic[8] = {true, true, true, true, true, true, true, true};
				...
				float timeLimit =
					0.0f; ///< Limite de temps en secondes (0 = pas de limite). A timeLeft<=0, le joueur en tete gagne.
