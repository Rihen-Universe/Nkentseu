...
int nkmain(const nkentseu::NkEntryState &state) {
	...
	fontConfig.yAxisUp = (api == NkGraphicsApi::NK_GFX_API_OPENGL)
							 ? true
							 : false; // OpenGL a l'axe Y vers le bas, les autres backends l'ont vers le haut
