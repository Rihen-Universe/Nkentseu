...
static NkKey SDLKeyToNk(SDL_Keycode k) {
	switch (k) {
		...
		case SDLK_LCTRL:
		case SDLK_RCTRL:
			return NkKey::NK_CTRL;
		case SDLK_LSHIFT:
		case SDLK_RSHIFT:
			return NkKey::NK_SHIFT;
		case SDLK_LALT:
		case SDLK_RALT:
			return NkKey::NK_ALT;
		default:
			return NkKey::NK_NONE;
	}
}
...
struct NkUIDemoApp {
		...
		bool Init() {
			...
			window = SDL_CreateWindow("NkUI Demo", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, kWidth, kHeight,
