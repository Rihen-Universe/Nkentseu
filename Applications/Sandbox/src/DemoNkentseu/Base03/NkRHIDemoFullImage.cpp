...
int nkmain(const nkentseu::NkEntryState &state) {
	...
	// loadedTexturePath =
	// "Resources/Textures/architecture-biologique-dévoilé-bâtiment-futuriste-avec-des-formes-sinueuses-empilées-et-du-verre-incurvé-vers-un-ciel-394868255.webp";
	...
	while (running) {
...

		{
			...
			NkMat4f matModel = NkMat4f::Translation(NkVec3f(1.6f, 0.f, 0.f)) * NkMat4f::RotationY(NkAngle(25.f));
			UboData ubo{};
...

		{
			...
			NkMat4f matModel = NkMat4f::Translation(NkVec3f(-1.8f, 0.f, 0.f)) * NkMat4f::RotationX(NkAngle(90.f));
			UboData ubo{};
			fillUboMain(ubo, matModel);
