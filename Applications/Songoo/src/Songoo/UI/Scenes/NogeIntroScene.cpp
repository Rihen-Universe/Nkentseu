...
namespace nkentseu {
	namespace songoo {
		...
		void NogeIntroScene::OnRender(AppContext &ctx) {
			...
			f.DrawStringCenteredScaled(r, FontAtlas::DisplaySlot, 1.4f, cx, cy - 40.f, "RIHEN UNIVERSE",
									   {255, 215, 0, a});
			f.DrawStringCenteredScaled(r, FontAtlas::SubtitleSlot, 1.f, cx, cy + 20.f, "presente",
