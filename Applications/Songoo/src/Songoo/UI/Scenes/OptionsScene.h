	...
	namespace songoo {
		class OptionsScene : public Scene {
			...
			private:
				...
				void DrawSlider(AppContext &ctx, const Slider &s, float val, const char *label, math::NkColor col);
				void DrawToggle(AppContext &ctx, float x, float y, float w, float h, bool on, const char *label,
								math::NkColor col);
