...
namespace nkentseu {
	namespace songoo {
		namespace theme {
			...
			inline math::NkColor Orange() {
				return {255, 107, 0, 255};
			} // terre cuite

			inline math::NkColor Cyan() {
			...
			inline math::NkColor ForestGreen() {
				return {30, 100, 40, 255};
			} // vert forêt

			inline math::NkColor DarkBrown() {
				return {90, 45, 10, 255};
			} // brun cacao

			inline math::NkColor Parchment() {
				return {255, 235, 184, 255};
			} // parchemin

			// Kente (bandeau décoratif)
			inline math::NkColor Kente0() {
				return {180, 70, 15, 220};
			}

			inline math::NkColor Kente1() {
				return {210, 160, 30, 220};
			}

			inline math::NkColor Kente2() {
				return {30, 100, 40, 220};
			}
