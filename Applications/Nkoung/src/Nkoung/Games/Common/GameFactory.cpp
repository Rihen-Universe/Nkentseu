...
namespace nkoung {
	...
	static const GameInfo kGameInfoTable[] = {
		{GameId::LaserPuzzle, "Laser Puzzle", "Puzzle avec laser et miroirs",
		 "Oriente des miroirs, prismes et portes pour guider un rayon lumineux vers une cible.", GameStatus::AlphaBuild,
		 true},
		{GameId::Territories, "Territoires", "Strategie au tour par tour",
		 "Capture des cases et bloque l'adversaire pour contrôler la carte.", GameStatus::NotStarted, false},
		{GameId::Labyrinth, "Gardien du Labyrinthe", "Aventure puzzle top-down",
		 "Explore des salles courtes, evite les murs, ouvre la route et atteins la sortie.", GameStatus::AlphaBuild,
		 true},
		{GameId::Bridges, "Ponts et Chemins", "Puzzle de tuiles",
		 "Place des routes et des ponts pour connecter plusieurs villages.", GameStatus::NotStarted, false},
		{GameId::Flow, "Flux", "Puzzle de canalisation", "Canalise le flux entre sources et puits sans croisements.",
		 GameStatus::NotStarted, false},
		{GameId::Tactics, "Tactique", "Strategie avancee",
		 "Stratégie avec unités, carte dynamique et conditions de victoire variées.", GameStatus::NotStarted, false}};
