#pragma once
// =============================================================================
// EN-TETE FIGE — ABI 3.0, tel qu'il etait avant l'ajout de la mineure 1.
//
// NE PAS METTRE A JOUR CE FICHIER. C'est tout son interet.
//
// Il sert a UNE chose : compiler un module « d'epoque » et verifier qu'il
// tourne encore dans l'atelier d'aujourd'hui. Sans cet en-tete, la promesse
// « une mineure en retard reste utilisable » ne serait qu'une intention.
//
// Il lui manque, par rapport a l'ABI courante :
//   GetCellCenter / GetCellShape / GetNeighbors   (fin de NkcRulesVTable)
//   abiMinor / vtableBytes                        (fin de NkcRulesInfo)
//   tout le canal de journal
//
// Si un jour ce fichier ne compile plus, ou si le module qu'il produit est
// refuse, c'est qu'une RUPTURE a ete introduite sans monter la MAJEURE.
// =============================================================================
// =============================================================================
...
namespace nkentseu {
	namespace conqueror {
		...
		// ---------------------------------------------------------------------
		inline constexpr uint32 kRulesAbiVersion = 3;   // MAJEURE 3, mineure 0
