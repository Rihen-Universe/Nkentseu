...
// --------------------------------------------------
// ConquerorGeometry.h est inclus par les modules des stagiaires, qui compilent
// avec TROIS -I et ne lient RIEN du moteur. Or une projection ecran demande
// cos/sin/sqrt/arrondi, et `NkRound` de NKMath est un symbole *lie* : le mettre
// dans le contrat casserait l'edition de liens de tout module.
//
// C'est aussi la bonne frontiere de conception : une regle de jeu ne connait pas
// les pixels. La distance entiere vit dans le contrat, la geometrie flottante
// vit ici.
//
// CE QU'IL Y A DEDANS
