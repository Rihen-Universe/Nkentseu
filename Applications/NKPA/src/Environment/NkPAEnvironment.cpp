...
namespace nkentseu {
	namespace nkpa {
		...
		void Environment::DrawSky(MeshBuilder &mb) const {
			...
			mb.AddTriangle({0.f, 0.f}, 0.35f, 0.55f, 0.85f, 1.f, {w, 0.f}, 0.35f, 0.55f, 0.85f, 1.f, {0.f, h}, 0.45f,
						   0.7f, 0.6f, 1.f);
			mb.AddTriangle({w, 0.f}, 0.35f, 0.55f, 0.85f, 1.f, {w, h}, 0.45f, 0.7f, 0.6f, 1.f, {0.f, h}, 0.45f, 0.7f,
						   0.6f, 1.f);
		}
		...
		void Environment::DrawLand(MeshBuilder &mb) const {
			...
			mb.AddTriangle({0.f, top}, 0.55f, 0.50f, 0.30f, 1.f, {w, top}, 0.55f, 0.50f, 0.30f, 1.f, {0.f, bot}, 0.35f,
						   0.28f, 0.18f, 1.f);
			mb.AddTriangle({w, top}, 0.55f, 0.50f, 0.30f, 1.f, {w, bot}, 0.35f, 0.28f, 0.18f, 1.f, {0.f, bot}, 0.35f,
						   0.28f, 0.18f, 1.f);

			// Bande d'herbe à la frontière terre/eau
			float32 grassH = 10.f;
			mb.AddTriangle({0.f, top}, 0.25f, 0.55f, 0.2f, 1.f, {w, top}, 0.25f, 0.55f, 0.2f, 1.f, {0.f, top + grassH},
						   0.15f, 0.4f, 0.1f, 1.f);
			mb.AddTriangle({w, top}, 0.25f, 0.55f, 0.2f, 1.f, {w, top + grassH}, 0.15f, 0.4f, 0.1f, 1.f,
			...
			const NkVector2f rocks[] = {{100.f, top + 18.f},
										{340.f, top + 22.f},
										{620.f, top + 14.f},
										{900.f, top + 20.f},
										{1150.f, top + 16.f}};
			...
			for (int32 r = 0; r < 5; ++r) {
				mb.AddEllipse(rocks[r], rsx[r], rsy[r], 0.f, 0.38f, 0.35f, 0.32f, 1.f, 12);
				mb.AddEllipse(rocks[r] - NkVector2f{3.f, 3.f}, rsx[r] * 0.6f, rsy[r] * 0.5f, 0.f, 0.5f, 0.48f, 0.45f,
							  0.5f, 10);
			}
		}
		...
		void Environment::DrawWater(MeshBuilder &mb) const {
			...
			mb.AddTriangle({0.f, mWaterY}, 0.06f, 0.18f, 0.38f, 1.f, {w, mWaterY}, 0.06f, 0.18f, 0.38f, 1.f, {0.f, bot},
						   0.03f, 0.10f, 0.22f, 1.f);
			mb.AddTriangle({w, mWaterY}, 0.06f, 0.18f, 0.38f, 1.f, {w, bot}, 0.03f, 0.10f, 0.22f, 1.f, {0.f, bot},
						   0.03f, 0.10f, 0.22f, 1.f);
			...
			for (int32 i = 0; i < WATER_VERTS - 1; ++i) {
				...
				mb.AddTriangle({x0, y0}, 0.25f, 0.55f, 0.78f, 0.75f, {x1, y1}, 0.25f, 0.55f, 0.78f, 0.75f, {x0, yBase},
							   0.06f, 0.18f, 0.38f, 0.8f);
				mb.AddTriangle({x1, y1}, 0.25f, 0.55f, 0.78f, 0.75f, {x1, yBase}, 0.06f, 0.18f, 0.38f, 0.8f,
		...
		void Environment::DrawClouds(MeshBuilder &mb) const {
			for (const auto &c : mClouds) {
				...
				mb.AddEllipse(p + NkVector2f{22.f * s, -4.f * s}, 26.f * s, 14.f * s, 0.f, 0.94f, 0.94f, 0.97f, 0.8f,
							  14);
				mb.AddEllipse(p - NkVector2f{20.f * s, 2.f * s}, 24.f * s, 13.f * s, 0.f, 0.94f, 0.94f, 0.97f, 0.8f,
							  14);
			}
		}
		...
		void Environment::DrawWindParticles(MeshBuilder &mb) const {
			for (const auto &p : mWind) {
				...
				mb.AddTriFlat(p.pos, p.pos + NkVector2f{0.f, p.size * 0.3f}, p.pos + d, p.r, p.g, p.b, alpha);
			}
		}
