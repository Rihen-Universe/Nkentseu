...
namespace nkentseu {
	namespace pv3de {
		...
		class PatientStatePanel {
			...
			private:
				void RenderEmotionBar(nkui::NkUIContext &ctx, nkui::NkUIDrawList &dl, nkui::NkUIFont &font,
									  nkui::NkUILayoutStack &ls, const NkEmotionOutput &emotion) noexcept;

				void RenderPhysioGauge(nkui::NkUIContext &ctx, nkui::NkUIDrawList &dl, nkui::NkUIFont &font,
									   nkui::NkUILayoutStack &ls, const char *label, nk_float32 value,
									   nk_float32 maxVal, nkui::NkColor color) noexcept;

				void RenderVitals(nkui::NkUIContext &ctx, nkui::NkUIDrawList &dl, nkui::NkUIFont &font,
