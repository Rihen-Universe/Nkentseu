...
namespace nkentseu {
	namespace pv3de {
		...
		void NkFaceController::BindAU(NkActionUnitId au, nk_uint32 bsIndex, nk_float32 weight) {
		...
		void NkFaceController::UpdateBlink(nk_float32 dt) {
			...
			if (mBlinking) {
				...
				nk_float32 closedness = (mBlinkPhase < 0.5f) ? mBlinkPhase * 2.f : (1.f - mBlinkPhase) * 2.f;
