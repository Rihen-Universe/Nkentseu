	...
	namespace pv3de {
		...
		class NkVisemeMapper {
			public:
				...
				static NkVector<NkVisemeFrame> Map(const NkString &text, nk_float32 durationMs);
		...
		class NkLipSyncController {
			...
			private:
				void ApplyViseme(NkViseme v, nk_float32 intensity, NkFaceController &fc);
