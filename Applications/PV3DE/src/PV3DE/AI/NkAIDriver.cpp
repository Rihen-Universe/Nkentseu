...
namespace nkentseu {
	namespace humanoid {
		...
		bool NkAIDriver::Init(const NkAIDriverConfig &config, const NkPersonality &personality) noexcept {
			mConfig = config;
		...
		// =====================================================================
		void NkAIDriver::Update(nk_float32 dt, nk_float32 pain, nk_float32 anxiety, nk_float32 fatigue) noexcept {
		...
		// =====================================================================
		void NkAIDriver::AskQuestion(const char *question, nk_float32 painLevel, nk_float32 anxietyLevel,
									 nk_float32 fatigueLevel, nk_float32 breathDifficulty, nk_float32 hr,
									 nk_float32 temp, nk_float32 spo2, NkAIResponseCallback callback) noexcept {
			if (mThinking) {
