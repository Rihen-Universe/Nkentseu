...
namespace nkentseu {
	namespace pv3de {
		...
		void NkDiagnosticEngine::RegisterBuiltinData() {
			// ── Symptômes ─────────────────────────────────────────────────────
			auto AddSym = [&](NkSymptomId id, const char *name, const char *desc, nk_float32 pain, nk_float32 anx,
