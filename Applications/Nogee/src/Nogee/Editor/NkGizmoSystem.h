	...
	namespace Noge {
		...
		class NkGizmoSystem {
			public:
				...
				void Update(ecs::NkWorld &world, const NkSelectionManager &sel, const NkEditorCamera &cam,
				...
				bool IsUsing() const noexcept {
					return mActiveAxis != NkGizmoAxis::None;
				}

				bool IsHovered() const noexcept {
					return mHoveredAxis != NkGizmoAxis::None;
				}
			...
			private:
				...
				void BuildTranslateGizmo(const NkVec3f &origin, const NkMat4f &vpMatrix, float32 screenScale) noexcept;
				void BuildRotateGizmo(const NkVec3f &origin, const NkMat4f &vpMatrix, float32 screenScale) noexcept;
				void BuildScaleGizmo(const NkVec3f &origin, const NkMat4f &vpMatrix, float32 screenScale) noexcept;

				NkGizmoAxis HitTest(const NkEditorCamera::Ray &ray, const NkVec3f &origin,
