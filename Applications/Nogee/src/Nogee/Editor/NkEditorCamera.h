	...
	namespace noge {
		...
		class NkEditorCamera {
			public:
				...
				void OnMouseMove(float32 dx, float32 dy, bool altDown, bool rightDown) noexcept;
				...
				Ray ScreenRay(float32 vpX, float32 vpY, float32 vpW, float32 vpH) const noexcept;
