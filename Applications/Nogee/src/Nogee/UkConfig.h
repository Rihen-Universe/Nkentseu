            ...
            void Initialize() noexcept {
                for (nk_usize i = 0; i < appConfig.entryState.GetArgCount(); ++i) {
                    ...
                    // --backend=vulkan|dx12|dx11|opengl|sw
                        ...
                        else if (backend == "dx12")   appConfig.deviceInfo.api = NkGraphicsApi::NK_GFX_API_DX12;
                        else if (backend == "dx11")   appConfig.deviceInfo.api = NkGraphicsApi::NK_GFX_API_DX11;
