...
namespace mou {
	...
	class MouGame {
		public:
			...
			void SetAssets(MouAssets *a) noexcept {
				mAssets = a;
			}
			...
			virtual MouFeedback::Cue ConsumeAudioCue() noexcept {
				return MouFeedback::Cue::None;
			}
			...
			virtual const char *ConsumeVoiceCue() noexcept {
				const char *v = mPendingVoice;
				mPendingVoice = nullptr;
				return v;
			}
