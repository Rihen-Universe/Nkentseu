...
namespace mou {
	...
	void MouPlant::Draw(const MouFrame &f, uint32 tex, float32 aspectWH, float32 x, float32 y, float32 w, float32 h,
	...
	void MouPlant::Slots(float32 rx, float32 ry, float32 rw, float32 rh, float32 canopyCYr, float32 canopyBWr,
						 float32 canopyBHr, int32 n, float32 fruitSz, float32 *outX, float32 *outY) noexcept {
		if (n <= 0)
			return;
