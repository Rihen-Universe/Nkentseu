...
namespace mou {
	...
	class MouPlant {
		public:
			...
			static void Draw(const MouFrame &f, nkentseu::uint32 tex, nkentseu::float32 aspectWH, nkentseu::float32 x,
							 nkentseu::float32 y, nkentseu::float32 w, nkentseu::float32 h, nkentseu::float32 &outX,
							 nkentseu::float32 &outY, nkentseu::float32 &outW, nkentseu::float32 &outH) noexcept;
			...
			static void Slots(nkentseu::float32 rx, nkentseu::float32 ry, nkentseu::float32 rw, nkentseu::float32 rh,
							  ...
							  nkentseu::int32 n, nkentseu::float32 fruitSz, nkentseu::float32 *outX,
							  nkentseu::float32 *outY) noexcept;
	};
