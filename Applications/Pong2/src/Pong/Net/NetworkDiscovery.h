...
#pragma pack(pop)
		static_assert(sizeof(PktBeacon) == 4 + 2 + 2 + 32 + 32 + 16, "PktBeacon layout cassee");
		...
		class NetworkDiscovery {
			public:
				...
				bool StartBeacon(const char *country, const char *city, const char *code, uint16 gamePort) noexcept;
				...
				/// Etat
				bool IsBeaconActive() const noexcept {
					return mBeaconSock != nullptr;
				}

				bool IsScanActive() const noexcept {
					return mScanSock != nullptr;
				}
