	...
	namespace pong {
		...
		class GameplayScene : public Scene {
			...
			private:
				...
				void EmitBurstNet(AppContext &ctx, float x, float y, int count, math::NkColor color, float speedMin,
								  float speedMax, float lifeMin, float lifeMax, float sizeMin, float sizeMax);
				...
				void EmitGoalNet(AppContext &ctx, float wallX, float arenaH, math::NkColor color);
