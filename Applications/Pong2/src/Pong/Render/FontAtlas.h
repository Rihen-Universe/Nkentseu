	...
	namespace pong {
		...
		class FontAtlas {
			public:
				...
				// ── Accesseurs ───────────────────────────────────────────────────
				uint32 TextureId() const noexcept {
					return mTextureId;
				}
				...
				float DrawString(GLRenderer2D &r, SizeSlot s, float x, float y, const char *text, math::NkColor color);
				/// Idem, centre horizontalement autour de @p cx.
				float DrawStringCentered(GLRenderer2D &r, SizeSlot s, float cx, float y, const char *text,
										 math::NkColor color);
				...
				float DrawStringScaled(GLRenderer2D &r, SizeSlot s, float scale, float x, float y, const char *text,
									   math::NkColor color);
				float DrawStringCenteredScaled(GLRenderer2D &r, SizeSlot s, float scale, float cx, float y,
											   const char *text, math::NkColor color);
				void DrawStringShadowScaled(GLRenderer2D &r, SizeSlot s, float scale, float x, float y,
											const char *text, math::NkColor textColor, math::NkColor shadowColor,
											int blurPixels = 2);
				void DrawStringShadowCenteredScaled(GLRenderer2D &r, SizeSlot s, float scale, float cx, float y,
				...
				void DrawStringShadow(GLRenderer2D &r, SizeSlot s, float x, float y, const char *text,
									  math::NkColor textColor, math::NkColor shadowColor, int blurPixels = 2);
				void DrawStringShadowCentered(GLRenderer2D &r, SizeSlot s, float cx, float y, const char *text,
											  math::NkColor textColor, math::NkColor shadowColor, int blurPixels = 2);
