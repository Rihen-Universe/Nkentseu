	...
	namespace pong {
		...
		class GLRenderer2D {
			public:
				...
				void DrawCircleOutline(float cx, float cy, float r, math::NkColor c, float thickness = 1.0f,
									   int segments = 48);
				...
				void DrawTexturedQuad(float x, float y, float w, float h, float u0, float v0, float u1, float v1,
									  math::NkColor color);
				...
				void DrawTexturedQuadRGBA(float x, float y, float w, float h, float u0, float v0, float u1, float v1,
										  math::NkColor color);

				// Info
				int ViewportW() const noexcept {
					return mViewportW;
				}

				int ViewportH() const noexcept {
					return mViewportH;
				}
