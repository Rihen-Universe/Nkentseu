...
\texttt{.vscode/settings.json}, \texttt{pyrightconfig.json}, et le dossier
\texttt{.jenga-typings/} du chapitre 2.
...
⚠️ \textbf{Le fichier produit est un instantané.} Il ne se met pas à jour quand
