...
Bonjour/.vscode/settings.json
\end{nkcode}

\begin{nkretenir}
\textbf{Deux des quatre ne servent qu'à votre éditeur.}
\texttt{pyrightconfig.json} et \texttt{.vscode/settings.json} font que
l'auto-complétion connaît le vocabulaire Jenga dans vos \texttt{.jenga} --- qui
sont du Python, donc analysables.
