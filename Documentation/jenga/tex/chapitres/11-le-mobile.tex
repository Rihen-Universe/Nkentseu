...
⚠️ Un contrôle qui exige un \texttt{classes.dex} déclarera donc cassé un APK qui
...
⚠️ \textbf{Et cherchez la valeur, pas le mot.} Dans un manifeste binaire,
...
⚠️ Et posez le contrôle positif : cherchez une chaîne dont vous savez qu'elle est
