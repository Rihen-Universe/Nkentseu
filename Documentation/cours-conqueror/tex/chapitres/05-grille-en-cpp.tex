...
\texttt{LoadBoardJson} vaut dans \nkfile{exemples/rules/RegleContratNu.cpp} :

\begin{nkcode}{exemples/rules/RegleContratNu.cpp — V\_LoadBoardJson}
...
\begin{nkcode}{exemples/rules/RegleContratNu.cpp — V\_Create}
...
Partez de \nkfile{RegleContratNu.cpp} et rendez son carré $5\times5$
