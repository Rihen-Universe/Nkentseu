\chapter{Écrire un moteur de règles}
...
\nkfile{Applications/ConquerorLab/exemples/rules/RegleMinimale.cpp}.
...
\begin{nkcode}{RegleMinimale.cpp — resume}
...
\begin{nkcode}{exemples/rules/RegleMinimale.cpp — section 1}
...
\begin{nkcode}{exemples/rules/RegleMinimale.cpp — section 2}
enum ParamId : int32 {
...
\begin{nkcode}{exemples/rules/RegleMinimale.cpp — V\_GetParamsSchemaJson}
...
\begin{nkcode}{exemples/rules/RegleMinimale.cpp — V\_SetParam}
...
\begin{nkcode}{exemples/rules/RegleMinimale.cpp — section 4}
struct State {
...
\begin{nkcode}{RegleMinimale.cpp — V\_CloneState}
...
\begin{nkcode}{RegleMinimale.cpp — V\_SerializeState}
...
\begin{nkcode}{exemples/rules/RegleMinimale.cpp — GenMoves}
...
\begin{nkcode}{exemples/rules/RegleMinimale.cpp — GenMoves, fin}
...
Dans \nkfile{RegleMinimale.cpp} les deux partagent délibérément la même
primitive, \texttt{CanPlay}, ce qui rend l'équivalence vraie par construction.
\end{nkretenir}

\section{Appliquer un coup, et la cascade}

\begin{nkcode}{exemples/rules/RegleMinimale.cpp — DoApply, placement}
...
\begin{nkcode}{exemples/rules/RegleMinimale.cpp — DoApply, transformation}
...
\begin{nkcode}{exemples/rules/RegleMinimale.cpp — CheckEnd}
...
\begin{nkcode}{exemples/rules/RegleMinimale.cpp — fin de fichier}
...
\begin{enumerate}
  \item copiez \nkfile{exemples/rules/RegleMinimale.cpp} vers
        \nkfile{Build/ConquerorLab/rules/mes\_regles.cpp} ;
