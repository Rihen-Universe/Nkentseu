...
\addlinespace
des règles & \texttt{RegleContratNu.cpp} \newline carré 5$\times$5 & — &
...
\nkfile{ConquerorRegleFacile.h} les écrit une fois : \texttt{RegleContratNu.cpp}
...
profil que \texttt{RegleContratNu} (14/16) et \texttt{GrilleLibre} (13/16).
...
\section{Des règles, sans échafaudage : RegleContratNu.cpp}
...
\begin{nkcode}{exemples/rules/RegleContratNu.cpp — le plateau, en C++}
