...
\begin{nkexo}[1 — Le plus court chemin vers un texte à l'écran]
...
\begin{nkexo}[3 — Écrire son propre rendu de texte]
...
\begin{nkexo}[4 — Toucher les plafonds]
