...
\begin{nkpiege}[Ne pas transposer l'ordre de l'ancien module]
L'ancien module d'interface, \texttt{NKUI}, avait l'ordre \emph{inverse}, et il
est documenté ainsi :

\begin{nkcode}{Applications/Sandbox/src/DemoNkentseu/NkUICanvas/NkUICanvasDemo.cpp:268-270}
...
\textbf{Ce commentaire ne s'applique pas à NKGui.} La démo NKGui pompe les
événements \emph{avant} \texttt{BeginFrame} (\nkfile{main.cpp:438} contre
\texttt{:468}), précisément parce que c'est \texttt{BeginFrame} qui fait le
travail de \texttt{NewFrame()}. Si vous copiez du code de l'ancien module, c'est
...
\begin{nkexo}[2 — Le piège des identifiants]
...
\begin{nkexo}[3 — Comprendre le z-ordre]
...
\begin{nkexo}[4 — Une modale correcte]
