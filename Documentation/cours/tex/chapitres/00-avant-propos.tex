...
\texttt{NKMedia}, \texttt{NKSL} (langage de \emph{shaders}), \texttt{NKUI}
...
\begin{nkexo}[1 — Reconnaître la carte]
...
\begin{nkexo}[2 — Le premier build]
...
\begin{nkexo}[3 — Chasse aux allocations]
