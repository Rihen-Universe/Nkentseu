...
\begin{nkexo}[1 — Faire tomber chaque panneau, un par un]
...
\begin{nkexo}[2 — Une vraie vignette de fichier]
...
\begin{nkexo}[4 — Une chaîne complète, de l'image à la vidéo et retour]
