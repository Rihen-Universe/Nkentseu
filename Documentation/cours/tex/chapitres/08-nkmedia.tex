...
\begin{nkexo}[1 — Sonder avant d'ouvrir]
...
\begin{nkexo}[2 — Le \emph{round-trip} complet]
...
\begin{nkexo}[3 — Prouver que \texttt{Close()} est obligatoire]
...
\begin{nkexo}[4 — Un lecteur cadencé, dans votre interface]
