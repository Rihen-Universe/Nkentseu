...
\begin{nkexo}[1 — Le flux de bits, sans réseau]
...
\begin{nkexo}[2 — Serveur et client dans le même programme]
...
\begin{nkexo}[3 — Un chat dans votre interface]
...
\begin{nkexo}[4 — Mesurer ce que coûte la fiabilité]
