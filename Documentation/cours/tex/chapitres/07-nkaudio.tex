...
\begin{nkexo}[1 — Le son au clic, complet]
...
\begin{nkexo}[2 — Mesurer sans écouter]
...
\begin{nkexo}[3 — Prouver l'ordre de fermeture]
...
\begin{nkexo}[4 — Un synthétiseur en dix lignes]
