...
\begin{nkexo}[1 — Le round-trip, et le format qui échoue]
...
\begin{nkexo}[2 — Rendre le stride visible]
...
\begin{nkexo}[3 — Une vignette dans une interface]
...
\begin{nkexo}[4 — Mesurer le mensonge]
