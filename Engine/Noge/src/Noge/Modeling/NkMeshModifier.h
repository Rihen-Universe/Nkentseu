...
namespace nkentseu {
	...
	class NkMeshModifier {
		public:
			 ...
			 */
			virtual void Apply(const NkEditableMesh &input, NkEditableMesh &output) const noexcept = 0;
	...
	class NkBevelModifier : public NkMeshModifier {
		public:
			...
			void Apply(const NkEditableMesh &in, NkEditableMesh &out) const noexcept override;
	...
	class NkModifierStack {
		public:
			 ...
			 */
			[[nodiscard]] NkEditableMesh ApplyUpTo(const NkEditableMesh &baseMesh, uint32 upToIndex) const noexcept;
