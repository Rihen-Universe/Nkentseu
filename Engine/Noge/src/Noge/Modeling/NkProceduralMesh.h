...
namespace nkentseu {
	namespace proc {
		...
		struct NkPlaneParams {
				float32 w = 1, h = 1;
				uint32 segW = 1, segH = 1;
		};
		...
		struct NkSphereParams {
				float32 r = 0.5f;
				uint32 rings = 16, segs = 32;
		};

		struct NkCylParams {
				float32 r = 0.5f, h = 1.f;
				uint32 segs = 32, rings = 1;
				bool caps = true;
		};
		...
		struct NkTorusParams {
				float32 majorR = 1.f, minorR = 0.25f;
				uint32 majorSegs = 48, minorSegs = 12;
		};

		struct NkGridParams {
				float32 w = 10.f, h = 10.f;
				uint32 segW = 10, segH = 10;
		};
