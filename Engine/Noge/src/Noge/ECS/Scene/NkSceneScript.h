	...
	namespace ecs {
		...
		class NkSceneScript {
			public:
				 ...
				 * @endcode
				 */
				[[nodiscard]] NkVector<NkGameObject> FindGameObjectsWithTag(const char *tag) const;
				 ...
				 * @endcode
				 */
				[[nodiscard]] NkGameObject FindGameObjectByName(const char *name) const;
				 ...
				 * @endcode
				 */
				template <typename T> [[nodiscard]] T *GetComponentInWorld() const;
				 ...
				 * @endcode
				 */
				[[nodiscard]] NkGameObject SpawnPrefab(const NkPrefab &prefab,
		 ...
		 */
		template <typename T> [[nodiscard]] T *NkSceneScript::GetComponentInWorld() const {
