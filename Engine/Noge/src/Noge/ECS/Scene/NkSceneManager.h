...
namespace nkentseu {
	namespace ecs {
		...
		struct NkSceneTransition {
				 ...
				 */
				[[nodiscard]] static NkSceneTransition WithLoading(const char *loadingScene,
																   nk_float32 fadeDur = 0.3f) noexcept {
		...
		class NkSceneManager {
			public:
				...
				bool LoadScene(const NkString &name,
							   const NkSceneTransition &transition = NkSceneTransition::Instant()) noexcept;
