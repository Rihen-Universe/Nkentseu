...
namespace nkentseu {
	...
	class NkSymmetryTool {
		public:
			 ...
			 */
			void GetMirrorPoints(NkVec2f pos, NkVector<NkVec2f> &out) const noexcept;
			 ...
			 */
			void DrawGuides(renderer::NkRender2D &r2d, const NkRectF &canvasRect, float32 zoom) const noexcept;
	};
	...
	class NkPerspectiveGuide {
		public:
			 ...
			 */
			void Draw(renderer::NkRender2D &r2d, const NkRectF &canvasRect, float32 zoom) const noexcept;
	};
	...
	class NkStabilizer {
		public:
			...
			[[nodiscard]] NkVec2f LastPos() const noexcept {
				return mLastStabilized;
			}
	...
	class NkAnimationAssist {
		public:
			...
			void DrawWithOnionSkin(renderer::NkRender2D &r2d, const NkRectF &dst) const noexcept;
	...
	class NkHybridDocument {
		public:
			...
			// ── Composition finale ────────────────────────────────────────────
			void Composite(renderer::NkRender2D &r2d, NkICommandBuffer *cmd, const NkRectF &dst) noexcept;
	};
