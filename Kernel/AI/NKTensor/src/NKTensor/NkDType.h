...
namespace nkentseu {
    namespace ai {
        ...
        inline nk_size NkDTypeSize(NkDType t) {
            switch (t) {
                case NkDType::NK_F32: return 4;
                case NkDType::NK_F64: return 8;
                case NkDType::NK_I32: return 4;
                case NkDType::NK_I64: return 8;
                case NkDType::NK_U8:  return 1;
                default:              return 0;
            }
        }
        ...
        inline const char* NkDTypeName(NkDType t) {
            switch (t) {
                case NkDType::NK_F32: return "f32";
                case NkDType::NK_F64: return "f64";
                case NkDType::NK_I32: return "i32";
                case NkDType::NK_I64: return "i64";
                case NkDType::NK_U8:  return "u8";
                default:              return "?";
            }
        }
        ...
        #define NK_DTYPE_DISPATCH(DT, TVAR, ...)                          \
            do {                                                          \
                switch (DT) {                                             \
                    case ::nkentseu::ai::NkDType::NK_F32: { using TVAR = float;   __VA_ARGS__ } break; \
                    case ::nkentseu::ai::NkDType::NK_F64: { using TVAR = double;  __VA_ARGS__ } break; \
                    case ::nkentseu::ai::NkDType::NK_I32: { using TVAR = ::nkentseu::int32; __VA_ARGS__ } break; \
                    case ::nkentseu::ai::NkDType::NK_I64: { using TVAR = ::nkentseu::int64; __VA_ARGS__ } break; \
                    case ::nkentseu::ai::NkDType::NK_U8:  { using TVAR = ::nkentseu::uint8; __VA_ARGS__ } break; \
                    default: break;                                       \
                }                                                         \
            } while (0)
