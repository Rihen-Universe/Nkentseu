...
TEST_CASE(NKMathBenchmark, TrigonometryLoopVsStd) {
	...
	const double nkNs = (static_cast<double>(nkT1 - nkT0) * 1000000000.0) / static_cast<double>(CLOCKS_PER_SEC);
	const double stdNs = (static_cast<double>(stdT1 - stdT0) * 1000000000.0) / static_cast<double>(CLOCKS_PER_SEC);
