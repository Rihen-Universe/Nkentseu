...
namespace nkentseu {
	namespace math {
		...
		// ---------------------------------------------------------------------
		NkRectangle::NkRectangle() : corner(0.0f, 0.0f), size(1.0f, 1.0f) {
		}
		...
		// ---------------------------------------------------------------------
		NkRectangle::NkRectangle(const NkVector2f &cornerPoint, const NkVector2f &dimensions)
			: corner(cornerPoint), size(dimensions) {
		}
		...
		// ---------------------------------------------------------------------
		NkRectangle::NkRectangle(float32 x, float32 y, float32 width, float32 height)
		...
		//   height      : hauteur du rectangle
		// ---------------------------------------------------------------------
		NkRectangle::NkRectangle(const NkVector2f &cornerPoint, float32 width, float32 height)
			: corner(cornerPoint), size(width, height) {
		}
		...
		//   dimensions  : largeur et hauteur du rectangle
		// ---------------------------------------------------------------------
		NkRectangle::NkRectangle(float32 x, float32 y, const NkVector2f &dimensions) : corner(x, y), size(dimensions) {
		}
		...
		bool NkRectangle::SeparatingAxis(const NkSegment &testAxis) {
			...
			NkRangeFloat rectangleProjection = NkRangeFloat::Hull(projectionEdgeA, projectionEdgeB);
		...
		// ---------------------------------------------------------------------
		NkRectangle NkRectangle::AABB(const NkRectangle *rectangleArray, int rectangleCount) {
