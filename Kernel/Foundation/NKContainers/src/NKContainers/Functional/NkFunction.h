...
namespace nkentseu {
    ...
    namespace detail {
        ...
        inline memory::NkAllocator* NkResolveFunctionAllocator(
    ...
    public:
        ...
        explicit NkFunction(
                memory::NkAllocator* allocator = &memory::NkGetDefaultAllocator()) noexcept
            : m_callable(nullptr)
        ...
        bool UsesSbo() const noexcept { return false; }
        static constexpr usize GetSboBufferSize() noexcept { return 0; }
