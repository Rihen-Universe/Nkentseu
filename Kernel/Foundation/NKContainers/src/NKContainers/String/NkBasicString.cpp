...
namespace nkentseu {
	...
	NkString16 NkToUTF16(const NkString8 &utf8Str) {
		...
		// -----------------------------------------------------------------
		encoding::NkConversionResult convResult =
			encoding::utf8::NkToUTF16(utf8Str.Data(), utf8Str.Length(), buffer, maxUnits, bytesRead, unitsWritten);
	...
	NkString32 NkToUTF32(const NkString8 &utf8Str) {
		...
		// -----------------------------------------------------------------
		encoding::NkConversionResult convResult =
			encoding::utf8::NkToUTF32(utf8Str.Data(), utf8Str.Length(), buffer, maxChars, bytesRead, charsWritten);
	...
	NkString8 NkToUTF8(const NkString16 &utf16Str) {
		...
		encoding::NkConversionResult convResult =
			encoding::utf16::NkToUTF8(reinterpret_cast<const uint16 *>(utf16Str.Data()), utf16Str.Length(), buffer,
									  maxBytes, unitsRead, bytesWritten);
	...
	NkString8 NkToUTF8(const NkString32 &utf32Str) {
		...
		// -----------------------------------------------------------------
		encoding::NkConversionResult convResult =
			encoding::utf32::NkToUTF8(reinterpret_cast<const uint32 *>(utf32Str.Data()), utf32Str.Length(), buffer,
									  maxBytes, charsRead, bytesWritten);
...
// ---------------------------------------------------------------------
	...
	NkWString NkToWide(const NkString8 &str) {
		...
		// -----------------------------------------------------------------
		return NkWString(reinterpret_cast<const wchar *>(utf32Intermediate.Data()), utf32Intermediate.Length());
	}
	...
	NkString8 NkFromWide(const NkWString &wstr) {
		...
		NkString32 utf32(reinterpret_cast<const char32 *>(wstr.Data()), wstr.Length());
