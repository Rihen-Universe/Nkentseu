...
namespace nkentseu {
	...
	class NkMetalComputeContext final : public NkIComputeContext {
		public:
			...
			NkComputeShader CreateShaderFromSource(const char *src, const char *entry = "computeMain") override;
			NkComputeShader CreateShaderFromFile(const char *path, const char *entry = "computeMain") override;
