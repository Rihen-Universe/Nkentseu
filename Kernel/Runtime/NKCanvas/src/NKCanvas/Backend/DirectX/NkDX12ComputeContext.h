...
namespace nkentseu {
	...
	class NkDX12ComputeContext final : public NkIComputeContext {
		public:
			...
			NkComputeShader CreateShaderFromSource(const char *src, const char *entry = "CSMain") override;
			NkComputeShader CreateShaderFromFile(const char *path, const char *entry = "CSMain") override;
