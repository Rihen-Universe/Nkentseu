...
namespace nkentseu {
	...
	class NkContextFactory {
		public:
			...
			static NkIGraphicsContext *Create(const NkWindow &window, const NkContextDesc &desc);
			...
			static NkIGraphicsContext *CreateWithFallback(const NkWindow &window, const NkGraphicsApi *preferenceOrder,
			...
			static NkIComputeContext *CreateCompute(NkGraphicsApi api, const NkContextDesc &desc = {});
