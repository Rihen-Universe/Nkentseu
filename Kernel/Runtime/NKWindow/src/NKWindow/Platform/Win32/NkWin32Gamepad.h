...
namespace nkentseu {
    ...
    namespace nk_xinput_dyn {
        ...
        inline HMODULE&    Module()  { static HMODULE    m = nullptr; return m; }
        inline FnGetState& PGet()    { static FnGetState p = nullptr; return p; }
        inline FnSetState& PSet()    { static FnSetState p = nullptr; return p; }
        inline FnGetCaps&  PCaps()   { static FnGetCaps  p = nullptr; return p; }
        inline FnGetBat&   PBattery(){ static FnGetBat   p = nullptr; return p; }
