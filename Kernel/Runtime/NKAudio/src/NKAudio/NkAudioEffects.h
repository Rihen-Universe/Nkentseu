	...
	namespace audio {
		...
		class NKENTSEU_AUDIO_API DelayEffect : public IAudioEffect {
			public:
				 ...
				 */
				DelayEffect(float32 delayTime, float32 feedback, float32 wet, int32 sampleRate,
		...
		class NKENTSEU_AUDIO_API ReverbEffect : public IAudioEffect {
			public:
				...
				explicit ReverbEffect(const Params &params, int32 sampleRate = 48000,
									  memory::NkAllocator *allocator = nullptr);
		...
		class NKENTSEU_AUDIO_API CompressorEffect : public IAudioEffect {
			public:
				...
				explicit CompressorEffect(const Params &params, int32 sampleRate = 48000);
				...
				AudioEffectType GetType() const override {
					return AudioEffectType::COMPRESSOR;
				}

				void SetParams(const Params &params);

				float32 GetCurrentGainReduction() const {
		...
		class NKENTSEU_AUDIO_API LimiterEffect : public IAudioEffect {
			public:
				...
				float32 GetCurrentGainReductionDb() const noexcept {
					return mGainReductionDb;
				}
		...
		class NKENTSEU_AUDIO_API BiquadFilter : public IAudioEffect {
			public:
				 ...
				 * @param sampleRate Fréquence d'échantillonnage
				 */
				BiquadFilter(FilterType type, float32 cutoffHz, float32 qFactor = 0.707f, float32 gainDb = 0.0f,
		...
		class NKENTSEU_AUDIO_API Eq3BandEffect : public IAudioEffect {
			public:
				...
				explicit Eq3BandEffect(const Params &params, int32 sampleRate = 48000);
				...
				AudioEffectType GetType() const override {
					return AudioEffectType::EQ_3BAND;
				}
		...
		class NKENTSEU_AUDIO_API DistortionEffect : public IAudioEffect {
			public:
				...
				DistortionEffect(DistortionType type = DistortionType::SOFT, float32 drive = 5.0f,
								 float32 output = 0.5f);
		...
		class NKENTSEU_AUDIO_API ChorusEffect : public IAudioEffect {
			public:
				ChorusEffect(float32 rate = 0.5f, float32 depth = 0.003f, float32 feedback = 0.3f, float32 wet = 0.5f,
							 int32 sampleRate = 48000, memory::NkAllocator *allocator = nullptr);
