	...
	namespace audio {
		...
		class NKENTSEU_AUDIO_API NkAudioBus {
			public:
				...
				int32 GetChildCount() const noexcept {
					return mChildCount;
				}
				...
				void SetSolo(bool solo) noexcept {
					mSoloed = solo;
				}
				...
				int32 GetEffectCount() const noexcept {
					return mEffectCount;
				}
				...
				NkAudioBus *GetSidechainSource() const noexcept {
					return mSidechainSrc;
				}
				...
				bool HasActiveVoice() const noexcept {
