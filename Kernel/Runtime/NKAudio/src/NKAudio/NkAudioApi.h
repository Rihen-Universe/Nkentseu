...
#warning                                                                                                               \
	"NKAudio: NKENTSEU_AUDIO_BUILD_SHARED_LIB et NKENTSEU_AUDIO_STATIC_LIB définis - NKENTSEU_AUDIO_STATIC_LIB ignoré"
#undef NKENTSEU_AUDIO_STATIC_LIB
#endif

#if defined(NKENTSEU_AUDIO_BUILD_SHARED_LIB) && defined(NKENTSEU_AUDIO_HEADER_ONLY)
#warning                                                                                                               \
	"NKAudio: NKENTSEU_AUDIO_BUILD_SHARED_LIB et NKENTSEU_AUDIO_HEADER_ONLY définis - NKENTSEU_AUDIO_HEADER_ONLY ignoré"
