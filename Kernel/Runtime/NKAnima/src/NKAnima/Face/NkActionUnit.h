#pragma once
// -----------------------------------------------------------------------------
// @File    Kernel/Runtime/NKAnima/src/NKAnima/Face/NkActionUnit.h
// @Author  TEUGUIA TADJUIDJE Rodolf Séderis — Rihen
// @Brief   Les 46 Action Units du Facial Action Coding System (Ekman & Friesen).
//
	...
	namespace anim {
		...
		struct NkActionUnit {
				...
				void Update(nk_float32 dt) {
					...
					if (diff > 0.f)
						intensity = (diff < step) ? target : intensity + step;
					else
						intensity = (-diff < step) ? target : intensity - step;
				}
		};
		...
		inline constexpr NkAUPreset kAU_PainSevere[] = {
			{NkActionUnitId::AU4, 0.9f},  {NkActionUnitId::AU6, 0.7f},	{NkActionUnitId::AU7, 0.8f},
			{NkActionUnitId::AU9, 0.5f},  {NkActionUnitId::AU10, 0.4f}, {NkActionUnitId::AU25, 0.6f},
			{NkActionUnitId::AU43, 0.3f},
		};

		// Anxiété
		inline constexpr NkAUPreset kAU_Anxious[] = {
			{NkActionUnitId::AU1, 0.6f}, {NkActionUnitId::AU2, 0.5f},  {NkActionUnitId::AU4, 0.3f},
			{NkActionUnitId::AU5, 0.7f}, {NkActionUnitId::AU20, 0.4f}, {NkActionUnitId::AU26, 0.2f},
		};

		// Nausée
		inline constexpr NkAUPreset kAU_Nauseous[] = {
			{NkActionUnitId::AU9, 0.6f},  {NkActionUnitId::AU15, 0.5f}, {NkActionUnitId::AU16, 0.3f},
			{NkActionUnitId::AU17, 0.4f}, {NkActionUnitId::AU25, 0.3f},
		};
