...
namespace nkentseu {
	...
	class NkFontEmbedded {
		public:
			 ...
			 */
			static NkFont *AddToAtlas(NkFontAtlas &atlas, NkEmbeddedFontId id, nkft_float32 sizePx = 0.f,
	...
	class NkFontEmbedder {
		public:
			 ...
			 */
			static bool GenerateHeader(const char *inputPath, const char *fontName, const char *outputPath);
			 ...
			 */
			static nkft_uint8 *Compress(const nkft_uint8 *data, nkft_size size, nkft_uint32 *outCompressedSize);
	};
