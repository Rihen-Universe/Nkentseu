...
enum class NkSLTokenKind : uint32 {
    ...
    NK_KW_SAMPLER1D, NK_KW_SAMPLER1D_ARRAY,
    NK_KW_SAMPLERCUBE_ARRAY, NK_KW_SAMPLERCUBE_ARRAY_SHADOW,
    NK_KW_SAMPLER2DMS,
    NK_KW_ISAMPLER1D, NK_KW_USAMPLER1D,
    NK_KW_ISAMPLER3D, NK_KW_USAMPLER3D,
    NK_KW_ISAMPLERCUBE, NK_KW_USAMPLERCUBE,
    NK_KW_ISAMPLER2D_ARRAY, NK_KW_USAMPLER2D_ARRAY,
    NK_KW_ISAMPLERCUBE_ARRAY, NK_KW_USAMPLERCUBE_ARRAY,
    NK_KW_IMAGE1D, NK_KW_IIMAGE1D, NK_KW_UIMAGE1D,
    NK_KW_IMAGE3D, NK_KW_IIMAGE3D, NK_KW_UIMAGE3D,
    NK_KW_IMAGECUBE, NK_KW_IIMAGECUBE, NK_KW_UIMAGECUBE,
    NK_KW_IMAGE2D_ARRAY, NK_KW_IIMAGE2D_ARRAY, NK_KW_UIMAGE2D_ARRAY,
