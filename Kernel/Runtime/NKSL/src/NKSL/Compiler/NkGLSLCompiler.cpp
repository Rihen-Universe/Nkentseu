...
// Gate UNIQUEMENT sur la disponibilité de glslang (NKGLSlang in-tree).
// Aucun couplage Vulkan : GLSL->SPIR-V ne dépend que de glslang.
#if defined(NK_RHI_GLSLANG_ENABLED)
