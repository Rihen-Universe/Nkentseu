...
namespace nkentseu {
	...
	struct NkSLResolvedType {
			...
			bool IsVoid() const {
				return base == NkSLBaseType::NK_VOID;
			}
			...
			bool IsVector() const {
				return base >= NkSLBaseType::NK_IVEC2 && base <= NkSLBaseType::NK_DVEC4;
			}

			bool IsMatrix() const {
				return base >= NkSLBaseType::NK_MAT2 && base <= NkSLBaseType::NK_DMAT4;
			}

			bool IsSampler() const {
				return NkSLTypeIsSampler(base);
			}

			bool IsImage() const {
				return NkSLTypeIsImage(base);
			}
			...
			static NkSLResolvedType Void() {
				return {NkSLBaseType::NK_VOID};
			}

			static NkSLResolvedType Bool() {
				return {NkSLBaseType::NK_BOOL};
			}

			static NkSLResolvedType Int() {
				return {NkSLBaseType::NK_INT};
			}

			static NkSLResolvedType UInt() {
				return {NkSLBaseType::NK_UINT};
			}

			static NkSLResolvedType Float() {
				return {NkSLBaseType::NK_FLOAT};
			}

			static NkSLResolvedType Vec2() {
				return {NkSLBaseType::NK_VEC2};
			}

			static NkSLResolvedType Vec3() {
				return {NkSLBaseType::NK_VEC3};
			}

			static NkSLResolvedType Vec4() {
				return {NkSLBaseType::NK_VEC4};
			}

			static NkSLResolvedType Mat3() {
				return {NkSLBaseType::NK_MAT3};
			}

			static NkSLResolvedType Mat4() {
	...
	class NkSLSymbolTable {
		public:
			...
			const NkSLFunctionOverload *ResolveFunction(const NkString &name,
			...
			static NkSLResolvedType BinaryResultType(const NkString &op, const NkSLResolvedType &lhs,
