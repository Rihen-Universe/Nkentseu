...
namespace nkentseu {
	...
	enum class NkSLTokenKind : uint32 {
		...
		// Samplers
		NK_KW_SAMPLER2D,
		NK_KW_SAMPLER2D_SHADOW,
		NK_KW_SAMPLER2D_ARRAY,
		NK_KW_SAMPLER2D_ARRAY_SHADOW,
		NK_KW_SAMPLERCUBE,
		NK_KW_SAMPLERCUBE_SHADOW,
		NK_KW_SAMPLER3D,
		NK_KW_ISAMPLER2D,
		NK_KW_USAMPLER2D,
		// Images
		...
		NK_KW_SAMPLER1D,
		NK_KW_SAMPLER1D_ARRAY,
		NK_KW_SAMPLERCUBE_ARRAY,
		NK_KW_SAMPLERCUBE_ARRAY_SHADOW,
		NK_KW_SAMPLER2DMS,
		NK_KW_ISAMPLER1D,
		NK_KW_USAMPLER1D,
		NK_KW_ISAMPLER3D,
		...
		NK_KW_ISAMPLERCUBE,
		NK_KW_USAMPLERCUBE,
		NK_KW_ISAMPLER2D_ARRAY,
		NK_KW_USAMPLER2D_ARRAY,
		NK_KW_ISAMPLERCUBE_ARRAY,
		NK_KW_USAMPLERCUBE_ARRAY,
		NK_KW_IMAGE1D,
		NK_KW_IIMAGE1D,
		NK_KW_UIMAGE1D,
		NK_KW_IMAGE3D,
		...
		NK_KW_UIMAGECUBE,
		NK_KW_IMAGE2D_ARRAY,
		NK_KW_IIMAGE2D_ARRAY,
		NK_KW_UIMAGE2D_ARRAY,
	...
	class NkSLLexer {
		public:
			...
			const NkVector<NkSLCompileError> &GetErrors() const {
				return mErrors;
			}
