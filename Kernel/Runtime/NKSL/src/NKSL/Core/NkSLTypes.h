...
namespace nkentseu {
    ...
    inline const char* NkSLTargetName(NkSLTarget t) {
        switch (t) {
            ...
            case NkSLTarget::NK_BYTECODE:       return "Bytecode(NkSLVM)";
    ...
    inline NkSLStage& operator|=(NkSLStage& a, NkSLStage b) { a = a | b; return a; }
    inline NkSLStage& operator&=(NkSLStage& a, NkSLStage b) { a = a & b; return a; }
    ...
    inline NkString NkSLStageToString(NkSLStage s) {
        ...
        NkString out;
        struct Bit { NkSLStage flag; const char* name; };
        static const Bit kBits[] = {
            { NkSLStage::NK_VERTEX,    "VERTEX"    },
            { NkSLStage::NK_FRAGMENT,  "FRAGMENT"  },
            { NkSLStage::NK_GEOMETRY,  "GEOMETRY"  },
            { NkSLStage::NK_TESS_CTRL, "TESS_CTRL" },
            { NkSLStage::NK_TESS_EVAL, "TESS_EVAL" },
            { NkSLStage::NK_COMPUTE,   "COMPUTE"   },
            { NkSLStage::NK_MESH,      "MESH"      },
            { NkSLStage::NK_TASK,      "TASK"      },
        };
