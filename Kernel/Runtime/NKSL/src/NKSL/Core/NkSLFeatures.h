...
namespace nkentseu {
	...
	struct NkSLFeatureCaps {
			...
			// ==========================================================================
			static NkSLFeatureCaps ForTarget(NkSLTarget t, uint32 hlslSM = 50) {
	...
	NkString GenerateTessEvalHLSL(const NkString &source, const NkSLTessLayout &layout, const NkSLCompileOptions &opts);
