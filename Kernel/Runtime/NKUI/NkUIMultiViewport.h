	...
	namespace nkui {
		...
		class NkUIMultiViewportManager {
			public:
				 ...
				 */
				bool Init(NkIDevice *device, NkRenderPassHandle mainRenderPass, NkGraphicsApi api, NkWindow *mainWindow,
						  int32 mainViewW, int32 mainViewH) noexcept;
				 ...
				 */
				void BeginFrame(NkUIContext &ctx, NkUIWindowManager &wm, float32 dt, int32 mainViewW,
				...
				int32 GetViewportCount() const noexcept {
					return mCount;
				}
