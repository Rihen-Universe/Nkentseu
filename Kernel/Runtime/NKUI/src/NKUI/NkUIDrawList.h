...
namespace nkentseu {
	namespace nkui {
		...
		struct NKUI_API NkUIDrawList {
				...
				void AddPolyline(const NkVec2 *pts, int32 n, NkColor col, float32 thickness = 1.f,
				...
				void AddRectFilledMultiColor(NkRect r, NkColor colTL, NkColor colTR, NkColor colBR,
											 NkColor colBL) noexcept;
				...
				void AddEllipse(NkVec2 center, float32 rx, float32 ry, NkColor col, float32 thickness = 1.f,
								int32 segs = 0) noexcept;

				// ── Arcs ──────────────────────────────────────────────────────────────────
				void AddArc(NkVec2 c, float32 r, float32 a0, float32 a1, NkColor col, float32 thickness = 1.f,
							int32 segs = 0) noexcept;
				void AddArcFilled(NkVec2 c, float32 r, float32 a0, float32 a1, NkColor col, int32 segs = 0) noexcept;

				// ── Bezier ────────────────────────────────────────────────────────────────
				void AddBezierCubic(NkVec2 p0, NkVec2 p1, NkVec2 p2, NkVec2 p3, NkColor col, float32 thickness = 1.f,
									int32 segs = 0) noexcept;
				void AddBezierQuadratic(NkVec2 p0, NkVec2 p1, NkVec2 p2, NkColor col, float32 thickness = 1.f,
										int32 segs = 0) noexcept;

				// ── Texte ─────────────────────────────────────────────────────────────────
				void AddText(NkVec2 pos, const char *text, NkColor col, float32 size = 0.f, uint32 fontId = 0) noexcept;
				void AddTextWrapped(NkRect bounds, const char *text, NkColor col, float32 size = 0.f,
									uint32 fontId = 0) noexcept;

				// ── Images / Textures ─────────────────────────────────────────────────────
				void AddImage(uint32 texId, NkRect dst, NkVec2 uvMin = {0, 0}, NkVec2 uvMax = {1, 1},
