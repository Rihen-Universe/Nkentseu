...
namespace nkentseu {
	namespace nkui {
		...
		struct NKUI_API NkUIMenu {
				...
				static bool BeginMenuBar(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, NkRect rect) noexcept;
				static void EndMenuBar(NkUIContext &ctx) noexcept;

				// ── Menu déroulant ────────────────────────────────────────────────────────
				/// Menu dans la menubar ou sous-menu d'un item.
				static bool BeginMenu(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, const char *label,
				...
				static bool MenuItem(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, const char *label,
									 const char *shortcut = nullptr, bool *selected = nullptr,
									 bool enabled = true) noexcept;
				...
				static bool BeginContextMenu(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font,
				...
				static bool BeginPopup(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, const char *id,
				...
				static bool BeginModal(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, const char *title,
									   bool *open = nullptr, NkVec2 size = {400, 200}) noexcept;
			...
			private:
				...
				static NkRect DrawMenuPanel(NkUIContext &ctx, NkUIDrawList &dl, const NkUIMenuState &ms) noexcept;
				static bool DrawMenuButton(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, const char *label,
										   NkRect r, bool open, bool enabled) noexcept;
				static NkRect CalcPanelRect(NkRect trigger, int32 depth, int32 itemCount) noexcept;
		};
	} // namespace nkui
} // namespace nkentseu
