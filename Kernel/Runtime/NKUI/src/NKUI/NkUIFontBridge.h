...
namespace nkentseu {
	namespace nkui {
		 ...
		 */
		using NkUIFontLoadFn = bool (*)(const char *path, const nkft_uint8 *data, nkft_size dataSize,
										nkft_float32 sizePx, void *userData, void **outHandle);
		 ...
		 */
		using NkUIFontGetGlyphFn = bool (*)(void *handle, nkft_uint32 cp, nkft_uint8 *atlasPixels, nkft_int32 atlasW,
											nkft_int32 atlasX, nkft_int32 atlasY, nkft_int32 glyphW, nkft_int32 glyphH,
											void *userData, NkUIGlyph *outGlyph);
		 ...
		 */
		using NkUIFontGetMetricsFn = void (*)(void *handle, void *userData, NkUIFontMetrics *outMetrics);
		 ...
		 * @return true si le glyphe existe.
		 */
		using NkUIFontGetBBoxFn = bool (*)(void *handle, nkft_uint32 cp, void *userData, nkft_int32 *outW,
										   nkft_int32 *outH);
		...
		struct NkUIFontBridge {
				 ...
				 * @return true si succès.
				 */
				bool InitFromFile(NkUIFontAtlas *atlas, NkUIFont *fontOut, const char *path, nkft_float32 sizePx,
								  const nkft_uint32 *ranges = nullptr);

				/**
				 * @brief Initialise le bridge avec NKFont depuis un buffer mémoire.
				 */
				bool InitFromMemory(NkUIFontAtlas *atlas, NkUIFont *fontOut, const nkft_uint8 *data, nkft_size dataSize,
									nkft_float32 sizePx, const nkft_uint32 *ranges = nullptr);
				 ...
				 * @return true si succès.
				 */
				bool InitCustom(NkUIFontAtlas *atlas, NkUIFont *fontOut, const char *path, nkft_float32 sizePx,
								const NkUIFontLoaderDesc &desc, const nkft_uint32 *ranges = nullptr);
