...
namespace nkentseu {
	namespace nkui {
		...
		struct NKUI_API NkUIWindow {
				...
				static bool Begin(NkUIContext &ctx, NkUIWindowManager &wm, NkUIDrawList &dl, NkUIFont &font,
								  NkUILayoutStack &ls, const char *name, bool *pOpen = nullptr,
								  NkUIWindowFlags flags = NkUIWindowFlags::NK_NONE) noexcept;

				// Termine la fenêtre courante
				static void End(NkUIContext &ctx, NkUIWindowManager &wm, NkUIDrawList &dl,
				...
				static void RenderAll(NkUIContext &ctx, NkUIWindowManager &wm, NkUIDrawList &dl,
			...
			private:
				...
				static void DrawTitleBar(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font,
