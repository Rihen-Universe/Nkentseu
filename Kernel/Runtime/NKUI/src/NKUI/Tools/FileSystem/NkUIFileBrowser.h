...
namespace nkentseu {
	namespace nkui {
		...
		struct NKUI_API NkUIFileBrowser {
				static NkUIFileBrowserResult Draw(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, NkUIID id,
												  NkRect rect, NkUIFileBrowserConfig &config,
												  NkUIFileBrowserState &state, const NkUIFSProvider &provider) noexcept;

				static void Navigate(NkUIFileBrowserState &state, const char *path) noexcept;
				static void Refresh(NkUIFileBrowserState &state, const NkUIFSProvider &provider,
									const NkUIFileBrowserConfig &config) noexcept;
				static const char *GetSelectedPath(const NkUIFileBrowserState &s) noexcept;
				static bool MatchesFilter(const NkUIFileEntry &e, const char *filter) noexcept;
				static void AddBookmark(NkUIFileBrowserConfig &cfg, const char *label, const char *path,
			...
			private:
				...
				static Layout ComputeLayout(NkRect r, const NkUIFileBrowserConfig &cfg) noexcept;
				static void DrawBackground(NkUIDrawList &dl, NkRect r, const NkUIContext &ctx) noexcept;
				static void DrawToolbar(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, const Layout &ly,
										NkUIFileBrowserConfig &cfg, NkUIFileBrowserState &state,
										const NkUIFSProvider &prov) noexcept;
				static void DrawBreadcrumb(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, const Layout &ly,
										   NkUIFileBrowserState &state) noexcept;
				static void DrawBookmarkPanel(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, const Layout &ly,
											  const NkUIFileBrowserConfig &cfg, NkUIFileBrowserState &state) noexcept;
				static void DrawColumnHeaders(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, const Layout &ly,
											  const NkUIFileBrowserConfig &cfg, NkUIFileBrowserState &state) noexcept;

				// Modes d'affichage
				static NkUIFileBrowserResult DrawListView(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, NkUIID id,
														  const Layout &ly, NkUIFileBrowserConfig &cfg,
														  NkUIFileBrowserState &state,
														  const NkUIFSProvider &prov) noexcept;
				static NkUIFileBrowserResult DrawGridView(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, NkUIID id,
														  const Layout &ly, NkUIFileBrowserConfig &cfg,
														  NkUIFileBrowserState &state,
														  const NkUIFSProvider &prov) noexcept;
				static NkUIFileBrowserResult DrawEntryRow(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font,
														  NkRect row, int32 idx, bool selected, bool hovered,
														  const NkUIFileBrowserConfig &cfg, NkUIFileBrowserState &state,
														  const NkUIFSProvider &prov) noexcept;
				static NkUIFileBrowserResult DrawGridCell(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font,
														  NkRect cell, int32 idx, bool selected, bool hovered,
														  float32 iconSize, NkUIFileBrowserState &state,
														  const NkUIFSProvider &prov) noexcept;
				static void DrawStatusBar(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, const Layout &ly,
										  const NkUIFileBrowserConfig &cfg, const NkUIFileBrowserState &state) noexcept;
				static NkUIFileBrowserResult DrawSaveRow(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, NkUIID id,
														 const Layout &ly, NkUIFileBrowserConfig &cfg,
														 NkUIFileBrowserState &state) noexcept;
				static NkUIFileBrowserResult DrawConfirmButtons(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font,
																const Layout &ly, const NkUIFileBrowserConfig &cfg,
																NkUIFileBrowserState &state) noexcept;
				static void DrawDeleteOverlay(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, NkRect rect,
											  NkUIFileBrowserState &state, NkUIFileBrowserResult &result) noexcept;
				static void DrawDndGhost(NkUIDrawList &dl, NkUIFont &font, const NkUIContext &ctx,
										 const NkUIFileBrowserState &state) noexcept;
				static void DrawCreateInlineFields(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, NkRect area,
												   NkUIFileBrowserState &state, const NkUIFSProvider &prov,
												   NkUIFileBrowserResult &result) noexcept;

				// Icônes dessinées en primitives (pas de texture)
				static void DrawIconFolder(NkUIDrawList &dl, NkRect r, NkColor col, bool open = false) noexcept;
				static void DrawIconFile(NkUIDrawList &dl, NkRect r, NkColor col) noexcept;
				static void DrawIconSymlink(NkUIDrawList &dl, NkRect r, NkColor col) noexcept;
				static void DrawIconTrash(NkUIDrawList &dl, NkRect r, NkColor col, bool full = false) noexcept;
				static void DrawIconNewFolder(NkUIDrawList &dl, NkRect r, NkColor col) noexcept;
				static void DrawIconNewFile(NkUIDrawList &dl, NkRect r, NkColor col) noexcept;
				static void DrawIconRefresh(NkUIDrawList &dl, NkRect r, NkColor col) noexcept;
				static void DrawIconList(NkUIDrawList &dl, NkRect r, NkColor col) noexcept;
				static void DrawIconGrid(NkUIDrawList &dl, NkRect r, NkColor col) noexcept;
				static void DrawIconSearch(NkUIDrawList &dl, NkRect r, NkColor col) noexcept;
				static void DrawEntryIcon(NkUIDrawList &dl, NkRect r, const NkUIFileEntry &e,
										  float32 scale = 1.f) noexcept;

				// Miniatures (couleur par type d'extension)
				static void DrawFileThumbnail(NkUIDrawList &dl, NkRect r, const NkUIFileEntry &e) noexcept;
				...
				static void SortEntries(NkUIFileBrowserState &s, NkUIFBSortCol col, bool asc) noexcept;

				// Gestion de l'interaction sélection unifiée
				static void HandleSelectionClick(NkUIFileBrowserConfig &cfg, NkUIFileBrowserState &state, int32 idx,
												 bool ctrl, bool shift) noexcept;
				static void HandleEntryActivate(NkUIFileBrowserState &state, int32 idx,
												NkUIFileBrowserResult &result) noexcept;
		...
		struct NKUI_API NkUIContentBrowser {
				...
				static NkUIContentBrowserResult Draw(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, NkUIID id,
													 NkRect rect, NkUIContentBrowserConfig &config,
													 NkUIContentBrowserState &state,
													 const NkUIFSProvider &provider) noexcept;

				/// Charge les assets d'un dossier depuis le filesystem.
				static void LoadFolder(NkUIContentBrowserState &state, const char *path,
									   const NkUIFSProvider &provider) noexcept;
			...
			private:
				static void DrawTree(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, NkRect rect,
				...
				static NkUIContentBrowserResult DrawAssetGrid(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font,
															  NkUIID id, NkRect rect, NkUIContentBrowserConfig &cfg,
															  NkUIContentBrowserState &state) noexcept;

				static void DrawAssetTile(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, NkRect cell, int32 idx,
										  bool selected, bool hovered, float32 thumbSize,
										  NkUIContentBrowserState &state, NkUIContentBrowserResult &result) noexcept;

				static void DrawToolbar(NkUIContext &ctx, NkUIDrawList &dl, NkUIFont &font, NkRect rect,
										NkUIContentBrowserConfig &cfg, NkUIContentBrowserState &state,
										const NkUIFSProvider &prov) noexcept;

				static void DrawAssetTypeIcon(NkUIDrawList &dl, NkRect r, NkUIAssetType t, bool large = false) noexcept;
				static NkColor AssetTypeColor(NkUIAssetType t) noexcept;

				static void BuildTree(NkUIContentBrowserState &state, const char *rootPath,
									  const NkUIFSProvider &prov) noexcept;
		};
