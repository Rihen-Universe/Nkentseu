...
OUVERTS_DECLARES = [
    ...
    ('recap', '18', u'qui s aligne : les planches ou le noeud de Rodolf'),
...
<g>
  ...
  <text x="52" y="1232" fill="#c8ccd4" font-size="12">· QUI S'ALIGNE SUR QUI — les planches, ou ton nœud de référence ? Ton dessin est une maquette à 6 × et l'en-tête de 21 px est déjà juste ; il reste à le dire (§ 13, point 18).</text>
