...
#include "NKContext/Backend/Software/NkSoftwareRenderer2D.h"
#include "NKContext/Backend/OpenGL/NkOpenGLRenderer2D.h"
#include "NKContext/Backend/Vulkan/NkVulkanRenderer2D.h"
#include "NKContext/Core/NkIGraphicsContext.h"
#include "NKLogger/NkLog.h"

#if defined(NKENTSEU_PLATFORM_WINDOWS)
#   include "NKContext/Backend/DirectX/NkDX11Renderer2D.h"
#   include "NKContext/Backend/DirectX/NkDX12Renderer2D.h"
#endif

#if defined(NKENTSEU_PLATFORM_MACOS) || defined(NKENTSEU_PLATFORM_IOS)
// Metal 2D renderer — forward declaration (implemented in NkMetalRenderer2D.mm)
// #include "NKContext/Backend/Metal/NkMetalRenderer2D.h"
#endif
