	...
	namespace renderer {
		...
		class NkPixolBuffer {
			public:
				...
				bool Init(NkIDevice *device, uint32 width, uint32 height, const NkPixolSculptConfig &cfg) noexcept;
				...
				[[nodiscard]] NkTextureHandle Depth() const noexcept {
					return mDepth;
				}

				[[nodiscard]] NkTextureHandle Normal() const noexcept {
					return mNormal;
				}

				[[nodiscard]] NkTextureHandle Material() const noexcept {
					return mMaterial;
				}

				[[nodiscard]] NkTextureHandle Color() const noexcept {
					return mColor;
				}

				[[nodiscard]] NkTextureHandle Mask() const noexcept {
					return mMask;
				}
				...
				[[nodiscard]] uint32 ResDepth() const noexcept {
					return mResDepth;
				}

				[[nodiscard]] uint32 ResNormal() const noexcept {
					return mResNormal;
				}

				[[nodiscard]] uint32 ResColor() const noexcept {
					return mResColor;
				}

				[[nodiscard]] uint32 ResMask() const noexcept {
					return mResMask;
				}
