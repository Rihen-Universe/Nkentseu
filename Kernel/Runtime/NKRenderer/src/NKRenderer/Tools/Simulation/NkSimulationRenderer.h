	...
	namespace renderer {
		...
		class NkSimulationRenderer {
			public:
				...
				void SubmitCharacter(NkMeshHandle mesh, NkMatInstHandle skinMaterial, const NkMat4f &transform,
									 const NkMat4f *boneMatrices, uint32 boneCount,
									 const NkBlendShapeState &blendShapes, const NkEmotionState &emotion);
				...
				// ── Effets biologiques ───────────────────────────────────────────────
				void UpdateSkinParams(NkMatInstHandle skinMat, const NkBlendShapeState &s, const NkEmotionState &e);
