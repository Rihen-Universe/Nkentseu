...
namespace nkentseu {
	namespace renderer {
		...
		inline const char *NkRString(NkRResult r) noexcept {
			switch (r) {
				case NkRResult::NK_OK:
					return "NK_OK";
				case NkRResult::NK_NOT_READY:
					return "NK_NOT_READY";
				case NkRResult::NK_PARTIAL:
					return "NK_PARTIAL";
				case NkRResult::NK_FALLBACK_USED:
					return "NK_FALLBACK_USED";
				case NkRResult::NK_ERR_INVALID_DEVICE:
					return "NK_ERR_INVALID_DEVICE";
				case NkRResult::NK_ERR_INVALID_HANDLE:
					return "NK_ERR_INVALID_HANDLE";
				case NkRResult::NK_ERR_INVALID_ARGUMENT:
					return "NK_ERR_INVALID_ARGUMENT";
				case NkRResult::NK_ERR_NOT_SUPPORTED:
					return "NK_ERR_NOT_SUPPORTED";
				case NkRResult::NK_ERR_NOT_FOUND:
					return "NK_ERR_NOT_FOUND";
				case NkRResult::NK_ERR_ALREADY_EXISTS:
					return "NK_ERR_ALREADY_EXISTS";
				case NkRResult::NK_ERR_COMPILE_FAILED:
					return "NK_ERR_COMPILE_FAILED";
				case NkRResult::NK_ERR_LINK_FAILED:
					return "NK_ERR_LINK_FAILED";
				case NkRResult::NK_ERR_IO:
					return "NK_ERR_IO";
				case NkRResult::NK_ERR_BAD_FORMAT:
					return "NK_ERR_BAD_FORMAT";
				case NkRResult::NK_ERR_OUT_OF_MEMORY:
					return "NK_ERR_OUT_OF_MEMORY";
				case NkRResult::NK_ERR_DEVICE_LOST:
					return "NK_ERR_DEVICE_LOST";
				case NkRResult::NK_ERR_DEVICE_REMOVED:
					return "NK_ERR_DEVICE_REMOVED";
				case NkRResult::NK_ERR_VALIDATION_FAILED:
					return "NK_ERR_VALIDATION_FAILED";
				default:
...
#define NK_R_TRY(expr)                                                                                                 \
	do {                                                                                                               \
		::nkentseu::renderer::NkRResult _r = (expr);                                                                   \
		if (!::nkentseu::renderer::NkROk(_r))                                                                          \
			return _r;                                                                                                 \
	} while (0)

// Set last error si la condition est fausse, et return false
#define NK_R_REQUIRE(cond, code, msg)                                                                                  \
	do {                                                                                                               \
		if (!(cond)) {                                                                                                 \
			::nkentseu::renderer::NkRSetLastError(code, msg);                                                          \
			return false;                                                                                              \
		}                                                                                                              \
	} while (0)
