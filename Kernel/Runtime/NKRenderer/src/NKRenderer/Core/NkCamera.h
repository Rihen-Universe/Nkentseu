	...
	namespace renderer {
		...
		class NkCamera3D : public NkCamera {
			public:
				...
				NkVec3f GetTarget() const noexcept {
					return mData.target;
				}
				...
				NkVec3f GetUp() const noexcept {
					return mData.up;
				}

				float32 GetFOV() const noexcept {
					return mData.fovY;
				}

				float32 GetNear() const noexcept {
					return mData.nearPlane;
				}

				float32 GetFar() const noexcept {
					return mData.farPlane;
				}

				float32 GetAspect() const noexcept {
					return mData.aspect;
				}
				...
				// Raw data
				const NkCamera3DData &GetData() const noexcept {
					return mData;
				}

				void SetData(const NkCamera3DData &d) noexcept {
					mData = d;
					mDirty = true;
				}
		...
		class NkCamera2D : public NkCamera {
			public:
				...
				NkVec2f GetCenter() const noexcept {
					return mData.center;
				}

				float32 GetZoom() const noexcept {
					return mData.zoom;
				}
				...
				const NkCamera2DData &GetData() const noexcept {
					return mData;
				}

				void SetData(const NkCamera2DData &d) noexcept {
					mData = d;
					mDirty = true;
				}
