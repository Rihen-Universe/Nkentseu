...
namespace nkentseu {
    namespace renderer {
        ...
        struct NkRendererConfig {
            ...
            // ── Presets ───────────────────────────────────────────────────────────
            static NkRendererConfig ForGame(NkGraphicsApi api = NkGraphicsApi::NK_GFX_API_OPENGL, uint32 w = 1920, uint32 h = 1080) {
            ...
            static NkRendererConfig ForFilm(NkGraphicsApi api = NkGraphicsApi::NK_GFX_API_VULKAN, uint32 w = 3840, uint32 h = 2160) {
                NkRendererConfig c; c.api=api; c.width=w; c.height=h;
            ...
            static NkRendererConfig ForArchviz(NkGraphicsApi api = NkGraphicsApi::NK_GFX_API_VULKAN, uint32 w = 2560, uint32 h = 1440) {
                NkRendererConfig c; c.api=api; c.width=w; c.height=h;
                c.pipeline=NkPipelineMode::NK_DEFERRED;
            ...
            static NkRendererConfig ForMobile(NkGraphicsApi api = NkGraphicsApi::NK_GFX_API_OPENGLES, uint32 w = 1280, uint32 h = 720) {
                NkRendererConfig c; c.api=api; c.width=w; c.height=h;
            ...
            static NkRendererConfig For2D(NkGraphicsApi api = NkGraphicsApi::NK_GFX_API_OPENGL, uint32 w = 1920, uint32 h = 1080) {
                NkRendererConfig c; c.api=api; c.width=w; c.height=h;
                c.pipeline=NkPipelineMode::NK_FORWARD;
            ...
            static NkRendererConfig ForEditor(NkGraphicsApi api = NkGraphicsApi::NK_GFX_API_OPENGL, uint32 w = 2560, uint32 h = 1440) {
                NkRendererConfig c; c.api=api; c.width=w; c.height=h;
                c.pipeline=NkPipelineMode::NK_FORWARD_PLUS;
                c.quality=NkRenderQuality::NK_HIGH;
                c.debugOverlay=true;
            ...
            static NkRendererConfig ForOffscreen(NkGraphicsApi api = NkGraphicsApi::NK_GFX_API_VULKAN, uint32 w = 3840, uint32 h = 2160) {
