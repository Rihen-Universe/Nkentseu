...
namespace nkentseu {
    namespace renderer {
        ...
        struct NkPassBuilder {
            ...
            math::NkVec3f  clearColorValue    = {0.05f,0.05f,0.07f};
            float32  clearColorAlpha    = 1.f;
            bool     clearDepth         = true;
            float32  clearDepthValue    = 1.f;
            bool     clearStencil       = true;
            float32  clearStencilValue  = 0.f;
            ...
            NkPassBuilder& ClearWith(math::NkVec3f c, float32 a = 1.f) { 
                clearColor=true; 
                clearColorValue=c; 
                clearColorAlpha=a; 
                return *this; 
        ...
        class NkRenderGraph {
            ...
            private:
                ...
                void TransitionResource(NkICommandBuffer* cmd, NkGraphResId resId, NkResourceState newState);
        };
