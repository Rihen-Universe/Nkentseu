// =============================================================================
// NKMedia/Codecs/Opus/Silk/NkSilkExcitationTables.cpp
// Tables d'excitation SILK — GÉNÉRÉES depuis libopus (tables_pulses_per_block.c,
// tables_other.c). Bit-exact (vérifié par diff). Ne pas éditer à la main.
// =============================================================================
...
const uint8 kSilk_pulses_per_block_iCDF[ 10 ][ 18 ] = {
{
...
const uint8 kSilk_rate_levels_iCDF[ 2 ][ 9 ] =
{
{
...
const uint8 kSilk_shell_code_table0[ 152 ] = {
...
const uint8 kSilk_shell_code_table1[ 152 ] = {
...
const uint8 kSilk_shell_code_table2[ 152 ] = {
...
const uint8 kSilk_shell_code_table3[ 152 ] = {
...
const uint8 kSilk_shell_code_table_offsets[ 17 ] = {
         0,      0,      2,      5,      9,     14,     20,     27,
        35,     44,     54,     65,     77,     90,    104,    119,
       135
};

const uint8 kSilk_sign_iCDF[ 42 ] = {
	...
	const uint8 kSilk_lsb_iCDF[2] = {120, 0};
