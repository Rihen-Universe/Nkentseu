// =============================================================================
// NKMedia/Codecs/Opus/Silk/NkSilkNlsfTables.cpp
// Codebooks NLSF NB/MB + WB — GÉNÉRÉS depuis libopus (tables_NLSF_CB_NB_MB.c,
// tables_NLSF_CB_WB.c). Contenu numérique bit-exact (vérifié par diff). Ne pas
// éditer à la main : régénérer depuis la référence.
// =============================================================================
...
static const uint8 kNlsf_CB1_NB_MB_Q8[ 320 ] = {
...
static const int16 kNlsf_CB1_Wght_Q9[ 320 ] = {
...
static const uint8 kNlsf_CB1_iCDF_NB_MB[ 64 ] = {
...
static const uint8 kNlsf_CB2_SELECT_NB_MB[ 160 ] = {
        16,      0,      0,      0,      0,     99,     66,     36,
...
static const uint8 kNlsf_CB2_iCDF_NB_MB[ 72 ] = {
...
static const uint8 kNlsf_CB2_BITS_NB_MB_Q5[ 72 ] = {
...
static const uint8 kNlsf_PRED_NB_MB_Q8[ 18 ] = {
       179,    138,    140,    148,    151,    149,    153,    151,
       163,    116,     67,     82,     59,     92,     72,    100,
        89,     92
};

static const int16 kNlsf_DELTA_MIN_NB_MB_Q15[ 11 ] = {
       250,      3,      6,      3,      3,      3,      4,      3,
         3,      3,    461
};

static const uint8 kNlsf_CB1_WB_Q8[ 512 ] = {
...
static const int16 kNlsf_CB1_WB_Wght_Q9[ 512 ] = {
...
static const uint8 kNlsf_CB1_iCDF_WB[ 64 ] = {
...
static const uint8 kNlsf_CB2_SELECT_WB[ 256 ] = {
         0,      0,      0,      0,      0,      0,      0,      1,
...
static const uint8 kNlsf_CB2_iCDF_WB[ 72 ] = {
...
static const uint8 kNlsf_CB2_BITS_WB_Q5[ 72 ] = {
...
static const uint8 kNlsf_PRED_WB_Q8[ 30 ] = {
...
static const int16 kNlsf_DELTA_MIN_WB_Q15[ 17 ] = {
       100,      3,     40,      3,      3,      3,      5,     14,
        14,     10,     11,      3,      8,      9,      7,      3,
       347
};

	// ── Instances codebook (miroir des silk_NLSF_CB_NB_MB / _WB) ─────────────
	const NkSilkNlsfCB kNlsfCB_NB_MB = {
		32, 10, NkSilkMath::FIX_CONST(0.18, 16), NkSilkMath::FIX_CONST(1.0 / 0.18, 6),
		kNlsf_CB1_NB_MB_Q8, kNlsf_CB1_Wght_Q9, kNlsf_CB1_iCDF_NB_MB, kNlsf_PRED_NB_MB_Q8,
		kNlsf_CB2_SELECT_NB_MB, kNlsf_CB2_iCDF_NB_MB, kNlsf_CB2_BITS_NB_MB_Q5, kNlsf_DELTA_MIN_NB_MB_Q15,
	};
	const NkSilkNlsfCB kNlsfCB_WB = {
		32, 16, NkSilkMath::FIX_CONST(0.15, 16), NkSilkMath::FIX_CONST(1.0 / 0.15, 6),
		kNlsf_CB1_WB_Q8, kNlsf_CB1_WB_Wght_Q9, kNlsf_CB1_iCDF_WB, kNlsf_PRED_WB_Q8,
		kNlsf_CB2_SELECT_WB, kNlsf_CB2_iCDF_WB, kNlsf_CB2_BITS_WB_Q5, kNlsf_DELTA_MIN_WB_Q15,
	};
