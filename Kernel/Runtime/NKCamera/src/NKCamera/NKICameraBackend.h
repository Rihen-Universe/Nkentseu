#pragma once
// =============================================================================
// NKICameraBackend.h — Contrat backend de capture caméra physique
// Convention : préfixe `NKI` pour les interfaces moteur (NK + I).
// =============================================================================
...
namespace nkentseu {
	...
	class NKICameraBackend {
		public:
			virtual ~NKICameraBackend() = default;
			...
			// -----------------------------------------------------------------------
			virtual bool SetAutoFocus(bool e) {
				(void)e;
				return false;
			}

			virtual bool SetAutoExposure(bool e) {
				(void)e;
				return false;
			}

			virtual bool SetAutoWhiteBalance(bool e) {
				(void)e;
				return false;
			}

			virtual bool SetZoom(float level) {
				(void)level;
				return false;
			}

			virtual bool SetFlash(bool e) {
				(void)e;
				return false;
			}

			virtual bool SetTorch(bool e) {
				(void)e;
				return false;
			}

			virtual bool SetFocusPoint(float x, float y) {
				(void)x;
				(void)y;
				return false;
			}
			...
			// -----------------------------------------------------------------------
			virtual bool GetOrientation(NkCameraOrientation &out) {
				(void)out;
				return false;
			}
	};
