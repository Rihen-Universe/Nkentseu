...
namespace nkentseu {
    ...
    class NkIDevice {
        public:
            ...
            // Command Buffers
            // =========================================================================
            virtual NkICommandBuffer* CreateCommandBuffer(NkCommandBufferType type=NkCommandBufferType::NK_GRAPHICS)                  = 0;
            ...
            virtual void Submit(NkICommandBuffer* const* cbs, uint32 count, NkFenceHandle signalFence = NkFenceHandle::Null())          = 0;
