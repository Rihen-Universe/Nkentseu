    ...
    namespace nksl {
        ...
        inline NkSLTarget ApiToTarget(NkGraphicsApi api) {
            switch (api) {
                ...
                case NkGraphicsApi::NK_GFX_API_DX11: return NkSLTarget::NK_HLSL_DX11;
                case NkGraphicsApi::NK_GFX_API_DX12: return NkSLTarget::NK_HLSL_DX12;
        ...
        inline NkSLTarget ApiToHLSLTarget(NkGraphicsApi api) {
            if (api == NkGraphicsApi::NK_GFX_API_DX12) return NkSLTarget::NK_HLSL_DX12;
