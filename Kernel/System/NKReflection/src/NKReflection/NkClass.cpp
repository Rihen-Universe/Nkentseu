...
namespace nkentseu {
	...
	namespace reflection {
		...
		*/
		 ...
		 * @endcode
		 */
		template <typename Visitor> void ForEachInHierarchy(const NkClass *startClass, Visitor &&visitor) {
		 ...
		 * @endcode
		 */
		const NkProperty *FindPropertyWithFlags(const NkClass &classMeta, const nk_char *name,
												nk_uint32 requiredFlags = 0, nk_uint32 forbiddenFlags = 0) {
		 ...
		 * @endcode
		 */
		nk_usize CollectAllProperties(const NkClass &classMeta, const NkProperty **outProperties, nk_usize maxCount) {
		 ...
		 * @endcode
		 */
		nk_usize CollectAllMethods(const NkClass &classMeta, const NkMethod **outMethods, nk_usize maxCount) {
