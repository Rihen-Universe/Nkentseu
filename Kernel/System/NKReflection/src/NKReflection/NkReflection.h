...
namespace nkentseu {
	...
	namespace reflection {
		 ...
		 */
		template <typename T> NKENTSEU_REFLECTION_API_INLINE const NkType *GetType() {
		 ...
		 */
		template <typename T> NKENTSEU_REFLECTION_API_INLINE const NkClass *GetClass() {
		 ...
		 * @endcode
		 */
		template <typename T> NKENTSEU_REFLECTION_API_INLINE T *CreateInstance() {
		 ...
		 */
		NKENTSEU_REFLECTION_API void DestroyInstanceByName(const nk_char *className, void *instance);
		 ...
		 */
		template <typename T> NKENTSEU_REFLECTION_API_INLINE void DestroyInstance(T *instance) {
			if (!instance) {
				return;
			}
			const NkClass *classMeta = NkRegistry::Get().GetClass<T>();
