...
namespace nkentseu {
	...
	namespace reflection {
		...
		namespace detail {
			...
			const NkClass &MakeMathClass(const nk_char *className, const nk_char *const (&names)[N]) {
				static_assert(N <= NK_MATH_MAX_COMPONENTS, "NkMathReflect : N composantes depasse le maximum (16)");
		...
		inline void NkRegisterMathReflection() {
			...
			static const nk_char *const matNames[16] = {"m0", "m1", "m2",  "m3",  "m4",	 "m5",	"m6",  "m7",
														"m8", "m9", "m10", "m11", "m12", "m13", "m14", "m15"};
			// Sous-vues de longueur exacte pour Mat2 (4) et Mat3 (9).
			static const nk_char *const mat2Names[4] = {"m0", "m1", "m2", "m3"};
			static const nk_char *const mat3Names[9] = {"m0", "m1", "m2", "m3", "m4", "m5", "m6", "m7", "m8"};
