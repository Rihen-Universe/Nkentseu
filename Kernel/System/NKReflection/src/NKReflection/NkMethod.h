	...
	namespace reflection {
		...
		class NKENTSEU_REFLECTION_API NkMethod {
			public:
				 ...
				 */
				NkMethod(const nk_char *name, const NkType &returnType, nk_uint32 flags = 0)
					: mName(name), mReturnType(&returnType), mFlags(flags), mInvoke(), mParameterTypes(nullptr),
					  mParameterCount(0) {
				}
				...
				static NkMethod MakeFromCallable(const nk_char *name, const NkType &returnType, Callable &&callable,
												 nk_uint32 flags = 0) {
				...
				static NkMethod MakeFromMember(ClassType *instance, ReturnType (ClassType::*methodPtr)(Args...),
											   const nk_char *name, const NkType &returnTypeMeta, nk_uint32 flags = 0) {
				 ...
				 */
				template <typename ClassType, typename ReturnType, typename... Args>
				static NkMethod MakeFromMember(ClassType *instance, ReturnType (ClassType::*methodPtr)(Args...) const,
											   const nk_char *name, const NkType &returnTypeMeta, nk_uint32 flags = 0) {
					NkMethod method(name, returnTypeMeta, flags | static_cast<nk_uint32>(NkMethodFlags::NK_MCONST));
				 ...
				 */
				NkReflectVariant InvokeVariant(void *instance, const NkReflectVariant *args, nk_int32 argCount) const {
					...
					if (mReturnType == nullptr || mReturnType->GetCategory() == NkTypeCategory::NK_VOID ||
						rawResult == nullptr) {
						return NkReflectVariant();
					}
			...
			private:
				...
				template <typename ClassType, typename ReturnType, typename... Args>
				void BindMember(ClassType *instance, ReturnType (ClassType::*methodPtr)(Args...)) {
					auto wrapper = [instance, methodPtr](void *obj, void **args) -> void * {
						NKENTSEU_UNUSED(obj);
						using Seq = nkentseu::NkMakeIndexSequence<sizeof...(Args)>;
						return CallMember<ClassType, ReturnType, Args...>(instance, methodPtr, args, Seq{});
					};
				...
				template <typename ClassType, typename ReturnType, typename... Args>
				void BindMemberConst(ClassType *instance, ReturnType (ClassType::*methodPtr)(Args...) const) {
					auto wrapper = [instance, methodPtr](void *obj, void **args) -> void * {
						NKENTSEU_UNUSED(obj);
						using Seq = nkentseu::NkMakeIndexSequence<sizeof...(Args)>;
						return CallMemberConst<ClassType, ReturnType, Args...>(instance, methodPtr, args, Seq{});
					};
					SetInvoke(InvokeFn(traits::NkMove(wrapper)));
				}
				...
				static void *CallMember(ClassType *instance, ReturnType (ClassType::*methodPtr)(Args...), void **args,
										nkentseu::NkIndexSequence<Ix...>) {
					if constexpr (traits::NkIsSame<ReturnType, void>::value) {
						(instance->*methodPtr)((*static_cast<traits::NkRemoveReference_t<Args> *>(args[Ix]))...);
						return nullptr;
					} else {
				...
				template <typename ClassType, typename ReturnType, typename... Args, nk_usize... Ix>
				static void *CallMemberConst(ClassType *instance, ReturnType (ClassType::*methodPtr)(Args...) const,
											 void **args, nkentseu::NkIndexSequence<Ix...>) {
					if constexpr (traits::NkIsSame<ReturnType, void>::value) {
						(instance->*methodPtr)((*static_cast<traits::NkRemoveReference_t<Args> *>(args[Ix]))...);
						return nullptr;
					} else {
				...
				template <typename... Args> void PopulateParameters() {
		...
		nkentseu::NkFunction<void(void *)> MakeThreadEntry(ClassType *instance, void (ClassType::*method)(void *)) {
			return nkentseu::NkBindThreadFunc(instance, method);
		}

		// Surcharge pour les methodes const (rare pour les thread entry)
		template <typename ClassType>
		nkentseu::NkFunction<void(void *)> MakeThreadEntry(ClassType *instance,
