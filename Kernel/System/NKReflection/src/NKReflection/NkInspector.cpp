...
namespace nkentseu {
	...
	namespace reflection {
		...
		// =================================================================
		NkEditableProperty DescribeEditableProperty(const NkProperty *prop, const void *instance) {
			...
			out.displayName = prop->GetDisplayName() ? prop->GetDisplayName() : prop->GetName();
			out.type = &type;
			...
			out.isObject = (type.GetCategory() == NkTypeCategory::NK_CLASS) && (type.GetClass() != nullptr);
		...
		// =================================================================
		NkVector<NkEditableProperty> EnumerateEditableProperties(const NkClass *cls, const void *instance) {
		...
		// SetPropertyByName
		// =================================================================
		nk_bool SetPropertyByName(const NkClass *cls, void *instance, const nk_char *name,
		...
		// GetPropertyByName
		// =================================================================
		NkReflectVariant GetPropertyByName(const NkClass *cls, const void *instance, const nk_char *name) {
			if (!cls || !instance || !name) {
