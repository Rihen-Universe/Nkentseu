...
namespace nkentseu {
	...
	namespace reflection {
		 ...
		 */
		NKENTSEU_REFLECTION_API NkEditableProperty DescribeEditableProperty(const NkProperty *prop,
																			const void *instance);
		 ...
		 */
		NKENTSEU_REFLECTION_API NkVector<NkEditableProperty> EnumerateEditableProperties(const NkClass *cls,
																						 const void *instance);
		 ...
		 */
		NKENTSEU_REFLECTION_API nk_bool SetPropertyByName(const NkClass *cls, void *instance, const nk_char *name,
		 ...
		 */
		NKENTSEU_REFLECTION_API NkReflectVariant GetPropertyByName(const NkClass *cls, const void *instance,
																   const nk_char *name);
		...
		template <typename T>
		auto NkResolveStaticClassImpl(int) -> decltype(&T::GetStaticClass(), (const NkClass *)nullptr) {
			return &T::GetStaticClass();
		}

		template <typename T> const NkClass *NkResolveStaticClassImpl(...) {
			return nullptr;
		}
		 ...
		 */
		template <typename T> const NkClass *NkResolveStaticClass() {
		 ...
		 * @endcode
		 */
		template <typename T> NkVector<NkEditableProperty> EnumerateEditableProperties(const T &obj) {
		...
		template <typename T> nk_bool SetPropertyByName(T &obj, const nk_char *name, const NkReflectVariant &value) {
			const NkClass *cls = NkResolveStaticClass<T>();
			return SetPropertyByName(cls, static_cast<void *>(&obj), name, value);
		}

		/** @brief Surcharge template de GetPropertyByName (resout T). */
		template <typename T> NkReflectVariant GetPropertyByName(const T &obj, const nk_char *name) {
			const NkClass *cls = NkResolveStaticClass<T>();
		 ...
		 */
		template <typename T, typename V> nk_bool SetPropertyValue(T &obj, const nk_char *name, const V &value) {
