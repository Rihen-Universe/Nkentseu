	...
	namespace net {
		...
		class NKENTSEU_NETWORK_CLASS_EXPORT NkConnection {
			public:
				 ...
				 */
				void InitAsServer(NkSocket *socket, const NkAddress &remote, NkPeerId localId,
				 ...
				 */
				void InitAsClient(NkSocket *socket, const NkAddress &remote, NkPeerId localId) noexcept;
				 ...
				 */
				[[nodiscard]] NkNetResult
				Send(const uint8 *data, uint32 size,
					 NkNetChannel channel = NkNetChannel::NK_NET_CHANNEL_RELIABLE_ORDERED) noexcept;
				...
				template <typename T>
				[[nodiscard]] NkNetResult
				SendObject(const T &obj, NkNetChannel ch = NkNetChannel::NK_NET_CHANNEL_RELIABLE_ORDERED) noexcept;
		...
		class NKENTSEU_NETWORK_CLASS_EXPORT NkConnectionManager {
			public:
				 ...
				 */
				[[nodiscard]] NkNetResult StartServer(uint16 port, uint32 maxClients = 64) noexcept;
				 ...
				 * @note Démarre le thread réseau interne pour polling automatique.
				 */
				[[nodiscard]] NkNetResult Connect(const NkAddress &serverAddr, uint16 localPort = 0) noexcept;
				 ...
				 */
				[[nodiscard]] NkNetResult
				SendTo(NkPeerId peer, const uint8 *data, uint32 size,
					   NkNetChannel ch = NkNetChannel::NK_NET_CHANNEL_RELIABLE_ORDERED) noexcept;
				 ...
				 * @endcode
				 */
				[[nodiscard]] bool GetConnectionStats(NkPeerId peer, NkConnectionStats &outStats) const noexcept;
			...
			private:
				...
				void DispatchPacket(const uint8 *data, uint32 size, const NkAddress &from) noexcept;
