...
// -------------------------------------------------------------
				 ...
				 * @endcode
				 */
				[[nodiscard]] static NkVector<NkAddress> Resolve(const char *host, uint16 port,
																 Family preferred = Family::NK_IP_V4) noexcept;
		...
		class NKENTSEU_NETWORK_CLASS_EXPORT NkSocket {
			public:
				 ...
				 */
				[[nodiscard]] NkNetResult SendTo(const void *data, uint32 size, const NkAddress &to) noexcept;
				 ...
				 */
				[[nodiscard]] NkNetResult RecvFrom(void *buf, uint32 bufSize, uint32 &outSize,
				 ...
				 * @return NkNetResult::OK si connexion acceptée, OK avec client invalide si aucune en attente
				 * (non-bloquant).
				 ...
				 * @endcode
				 */
				static NkNetResult Select(NkSpan<NkSocket *> readSockets, uint32 timeoutMs,
