	...
	namespace net {
		...
		class NKENTSEU_NETWORK_CLASS_EXPORT NkReliableChannel {
			public:
				 ...
				 */
				[[nodiscard]] uint32 PrepareReliable(const uint8 *data, uint32 size, NkNetChannel ch) noexcept;
				 ...
				 */
				void GatherPendingSends(NkTimestampMs now, float32 rto, NkVector<const NkSendEntry *> &out) noexcept;
				 ...
				 */
				[[nodiscard]] bool InsertReceived(uint32 seqNum, const uint8 *data, uint32 size) noexcept;
		...
		class NKENTSEU_NETWORK_CLASS_EXPORT NkReliableUDP {
			public:
				 ...
				 */
				[[nodiscard]] NkNetResult Send(const uint8 *data, uint32 size, NkNetChannel channel) noexcept;
			...
			private:
				 ...
				 */
				[[nodiscard]] NkNetResult SendFragmented(const uint8 *data, uint32 size, NkNetChannel ch) noexcept;
				 ...
				 */
				[[nodiscard]] bool TryReassemble(uint8 fragIdx, uint8 fragCount, uint32 seqBase, const uint8 *data,
