	...
	namespace net {
		...
		class NKENTSEU_NETWORK_CLASS_EXPORT NkRPCRouter {
			public:
				 ...
				 */
				[[nodiscard]] uint32 Register(const char *name, NkRPCType type, NkRPCDescriptor::HandlerFn handler,
											  NkRPCReliability rel = NkRPCReliability::NK_RELIABLE_ORD) noexcept;
				...
				[[nodiscard]] NkNetResult CallServer(const char *rpcName, Args &&...args) noexcept;
				 ...
				 */
				template <typename... Args>
				[[nodiscard]] NkNetResult CallClient(NkPeerId target, const char *rpcName, Args &&...args) noexcept;
				 ...
				 */
				template <typename... Args>
				[[nodiscard]] NkNetResult Multicast(const char *rpcName, Args &&...args) noexcept;
				 ...
				 */
				void OnRPCReceived(NkPeerId caller, const uint8 *data, uint32 size) noexcept;
			...
			private:
				 ...
				 */
				template <typename... Args>
				[[nodiscard]] NkNetResult CallInternal(NkRPCType type, NkPeerId target, const char *rpcName,
													   Args &&...args) noexcept;
