...
namespace nkentseu {
	...
	namespace {
		...
		// -------------------------------------------------------------------------
		void WriteNodeJSON(const NkArchiveNode &node, NkString &out, bool pretty, int indent, int level) noexcept;

		void WriteArchiveJSON(const NkArchive &archive, NkString &out, bool pretty, int indent, int level) noexcept;
	 ...
	 */
	nk_bool NkJSONWriter::WriteArchive(const NkArchive &archive, NkString &outJson, nk_bool pretty,
