...
namespace nkentseu {
	...
	namespace {
		...
		// -------------------------------------------------------------------------
		void NkWriteArchiveXML(const NkArchive &archive, NkString &out, nk_bool pretty, nk_int32 spaces,
							   nk_int32 level) noexcept;

		void NkWriteNodeXML(NkStringView key, const NkArchiveNode &node, NkString &out, nk_bool pretty, nk_int32 spaces,
							nk_int32 level) noexcept;
	 ...
	 */
	nk_bool NkXMLWriter::WriteArchive(const NkArchive &archive, NkString &outXml, nk_bool pretty,
